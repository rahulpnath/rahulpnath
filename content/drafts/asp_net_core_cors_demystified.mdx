...
tags:
  - ASP.NET
keywords:
description: Cross Origin Resource Sharing or CORS in short is a W3C standard that allows a server to relax the same-origin policy. Learn more about it and how to enable it for an ASP NET Web API.
