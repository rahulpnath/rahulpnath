...
If you are new to building Azure Functions, check out my [Azure Functions ⚡ For The .NET Developer](https://www.rahulpnath.com/blog/getting-started-with-azure-functions/) post to quickly get started. I’ll continue using the sample Function I used there and extend it to support Dependency Injection.

`youtube:https://www.youtube.com/embed/m_jrALXcrXc`

## Setting Up Dependency Injection

The Azure Functions we [wrote earlier](https://www.rahulpnath.com/blog/getting-started-with-azure-functions/) logs to the console. Say we want to do some business-related processing every time we get a message in the queue. 
...
The default Function class created by the Visual Studio template (in the [previous example](https://www.rahulpnath.com/blog/getting-started-with-azure-functions/)) is a static method in a static class. 
...
`youtube:https://www.youtube.com/embed/dxBlBltEDRs`
...
`youtube:https://www.youtube.com/embed/v=5GlgHV_12-k`
