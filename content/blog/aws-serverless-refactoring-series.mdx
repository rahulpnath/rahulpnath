...
date: 2021-05-03 12:10:00+00:00
tags:
  - AWS
  - Serverless
  - Dotnet-Core
...
thumbnail: ../images/aws_serverless_refactor.jpg
popular: true
draft: false
---
...
In the [Going Serverless on AWS For the .NET Developer](https://www.rahulpnath.com/blog/aws-serverless-application/), I showed how to get started with building Serverless Application in AWS.
If you are new to AWS Serverless, I recommend reading that and coming back to this post.
