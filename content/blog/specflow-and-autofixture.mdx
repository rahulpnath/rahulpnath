...
So to remove this, what we need is a generic way to specify instances (generated from AutoFixture) whenever it's asked for a DTO, Model or an Entity class. The default DI container shipped with SpecFlow has limited functionality, and I did not find an integration point for this.
...
inject it with dummy data populated.
