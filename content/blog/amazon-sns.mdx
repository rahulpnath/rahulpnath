...
![Amazon SNS create new Standard topic ](../images/amazon-sns-create-topic.jpg)
...
![Use Email Protocol for the subscriber and specify the email to which the messages must be sent. ](../images/amazon-sns-email-subscription.jpg)
...
![AWS Lambda permissions to access SNS - In this case it has full access to the specific SNS Topic.](../images/amazon-sns-lambda-permissions.jpg)

Under the Lambda → Triggers, you can add a new Trigger and set up the integration with Amazon SNS.

![Setting up a SNS Trigger for Amazon Lambda amazon-sns-lambda-trigger.jpg](../images/amazon-sns-lambda-trigger.jpg)
...
![Subscription Filter policy to filter out messages only for the month of Februrary.](../images/amazon-sns-subscription-filter-policy.jpg)
...
![Dead letter Queue (DLQ) attached to a SNS Subscription.](../images/amazon-sns-subscription-dlq.jpg)
