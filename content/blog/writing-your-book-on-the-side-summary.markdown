...
tags:
  - Books
  - Notes
description: Write Your Book on the Side is a free and great step-by-step guide from beginning to end on self-publishing a book. Though some of the chapters are very specific to selling on Amazon, it has many tips and suggestions to help publish a book in general. Recommend this quick read if you are already writing and planning to publish a book but finding it too overwhelming (like me).
thumbnail: ../images/write_book_on_the_side.jpg
popular: true
draft: false
---
