...
Initially, I was looking at apps that can integrate with [Todoist](/blog/todoist-manage-your-todo-list/), my task management tool. There are a lot of [pomodoro apps that integrate with Todoist](https://support.todoist.com/hc/en-us/articles/210762349-Pomodoro-with-Todoist), but I found all of them an overkill.
