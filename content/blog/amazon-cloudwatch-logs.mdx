...
`youtube:https://www.youtube.com/embed/-46yTm4DoEI`
...
The [AWSSDK.CloudWatchLogs](https://www.notion.so/How-To-Log-Correctly-To-AWS-CloudWatch-From-a-NET-Application-4f6f7a335b204ca9b567a146f3bf9c2c) NuGet package provides the `AmazonCloudWatchLogsClient` to interact with CloudWatch logs. It provides capabilities to create log groups, log streams, and log events.
...
We could abstract this into a different class and expose more specific functions to take in just the message and log. But this is already done for you. 
So don’t repeat it yourself 😀
...
*eg. {$.count > 10 && $.cityName = “Brisbane”}* → selects all log events that have a count property greater than 0 with the cityName property as Brisbane.
