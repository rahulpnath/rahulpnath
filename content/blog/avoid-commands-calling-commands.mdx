...
The [MediatR](https://github.com/jbogard/MediatR) library provides an in-process messaging solution and enables applying CQRS pattern to our application code. The library support Commands, Queries, Notifications, Events, and a lot more make it easy to follow the CQRS pattern.
