...
date: '2023-11-16'
feature_image: /content/images/2023/11/Powertools---Logging.png
tags:
  - AWS
  - Lambda
excerpt: >-
  Powertools for AWS Lambda (.NET) Logging utility provides a Lambda-optimized
  logger to output JSON logs. In this blog post, let's learn how to get started
  with the Powertools for Lambda logging utility when building Lambda Functions
  in .NET.
---
...
<EmbedCard src="https://www.youtube.com/embed/uQxAIYkdNFM?feature=oembed" title="LOGGING - Powertools for AWS Lambda | .NET ON AWS | Serverless | Amazon" />
