...
I keep getting this question. I had covered how to [Continuously Deploy Your .NET Core Azure WebJobs](/posts/azure-webjobs-dotnet-core-build-depoy/) in a previous post. Check that out if you are getting started with WebJobs.
...
*   **WebJobExample.WebJob -** Web Job Application (set up in this [post in detail](/posts/azure-webjobs-dotnet-core-build-depoy/))
