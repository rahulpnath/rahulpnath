...
excerpt: >-
  Creating and managing Azure Key Vault was mostly supported through PowerShell
  cmdlets initially(GHOSTURL/blog/getting-started-with-azure-key-vault/), but
  there are multiple ways of achieving this now - REST API,
  PowerShell(GHOSTURL/blog/how-the-deprecation-of-switch-azuremode-affects-azure-key-vault/),
  CLI or ARM
  templates(GHOSTURL/blog/managing-azure-key-vaults-using-azure-resource-manager-arm-templates/)....
tags:
  - Azure
---
