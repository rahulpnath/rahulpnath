...
<Figure src="/images/dynamodb-stream-enable-existing-table.jpg" caption="### Stream View Types" />
...
<Figure src="/images/dynamodb-stream-details.jpg" caption="## Handling DynamoDB Stream Events" />
...
<Figure src="/images/dynamodb-stream-lambda-trigger-edit-configuration.jpg" caption="**Batch Size and Batch Window**" />
