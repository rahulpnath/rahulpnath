...
excerpt: >-
  !Testing(/images/testing.jpg)(https://www.flickr.com/photos/toomore/23066277453)  In the earlier post, Removing Unnecessary Dependencies(GHOSTURL/blog/refactoring-to-improve-testability-removing-unnecessary-dependencies/), we saw how having an unnecessary dependency hinders testability. In this post we will see how the test code changed by...
tags:
  - Programming
  - Testing
---
