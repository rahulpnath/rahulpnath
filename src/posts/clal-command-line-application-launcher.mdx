...
date: '2016-04-07'
feature_image: /content/images/clal.png
tags:
  - Tools
---
...
<ImageCard src="/content/images/clal.png" alt="Command Line Application Launcher" />
...
<ImageCard src="/content/images/clal_new.png" alt="Command Line Application Launcher" />
...
[**Contribute**](https://github.com/rahulpnath/clal/issues) to the development by coding or reporting issues that you find file using the application. [Check out these articles](/tag/clal/) for my learnings while building this application.
