...
[<Figure src="/images/test_data.jpg)](http://xunitpatterns.com/Data-Driven%20Test.html" caption="Let's start with some simple tests on a Customer class shown below." />
