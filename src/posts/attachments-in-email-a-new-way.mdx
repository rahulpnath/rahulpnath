...
date: 2010-11-25
excerpt: >-
  Just a though on a new mail attachment way :).  What if we could attach existing attachments in our mailbox to new mails that we want to send.Forwarding the...
tags:
  - Thoughts
---
