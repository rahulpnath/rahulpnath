...
<Figure src="/images/image-9.png" caption="EventBridge Lambda Trigger setup with a rate expression of 1 day" />
...
<Figure src="/images/image-11.png" caption="Amazon EventBridge Rule detail that runs every minute." />
...
<Figure src="/images/image-12.png" caption="### Customizing EventBridge Trigger Payload For Lambda" />
...
<Figure src="/images/image-14.png" caption="Cron Expression example Lambda Trigger using AWS EventBridge" />
...
<Figure src="/images/image-15.png" caption="CRON AWS EventBridge Rule detail showing the Event Schedule and the Next 10 trigger dates." />
