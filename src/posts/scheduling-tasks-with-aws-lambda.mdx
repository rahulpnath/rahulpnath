---
title: >-
  Serverless Task Automation: Task Scheduling with AWS Lambda and Amazon
  EventBridge
slug: scheduling-tasks-with-aws-lambda
date: '2023-10-30'
feature_image: /content/images/2023/10/scheduling-tasks-lambda.png
tags:
  - AWS
  - Lambda
excerpt: >-
  Learn how to use Amazon EventBridge Scheduler to setup and schedule triggers
  for Lambda Functions using rate and cron expressions.
---
...
<EmbedCard src="https://www.youtube.com/embed/P6yp0ByekEk?feature=oembed" title="SCHEDULING TASKS ON AWS LAMBDA | .NET ON AWS | Serverless | Amazon" />
...
_This article is sponsored by AWS and is part of my [_AWS Series_](/blog/tag/aws/)._
...
<ImageCard src="/content/images/2023/10/image-9.png" alt="EventBridge Lambda Trigger setup with a rate expression of 1 day" caption="EventBridge Lambda Trigger setup with a rate expression of 1 day" />
...
<ImageCard src="/content/images/2023/10/image-11.png" alt="Amazon EventBridge Rule detail that runs every minute." caption="Amazon EventBridge Rule detail that runs every minute." />
...
<ImageCard src="/content/images/2023/10/image-12.png" alt="" />
...
<ImageCard src="/content/images/2023/10/image-13.png" alt="" />
...
<ImageCard src="/content/images/2023/10/image-14.png" alt="Cron Expression example Lambda Trigger using AWS EventBridge" caption="Cron Expression example Lambda Trigger using AWS EventBridge" />
...
<ImageCard src="/content/images/2023/10/image-15.png" alt="CRON AWS EventBridge Rule detail showing the Event Schedule and the Next 10 trigger dates." caption="CRON AWS EventBridge Rule detail showing the Event Schedule and the Next 10 trigger dates." />
