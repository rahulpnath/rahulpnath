...
excerpt: >-
  Many applications today provide features that integrate with users location and provide information on a map based on that. In this blog will see how we can use the Bing...
tags:
  - Dotnet
---
...
<Figure src="/images/Bing_wp_route.jpg" caption="![Bing_wp_place_search](/images/Bing_wp_place_search.jpg)" />

<Figure src="/images/Bing_wp_directions_text.jpg" caption="**Testing**" />
