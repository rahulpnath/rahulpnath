...
Digital Signature is a mechanism to ensure the validity of a digital document or message. Digital signatures use [asymmetric cryptography](/posts/getting-started-with-azure-key-vault/) - uses a public and private key pair.
