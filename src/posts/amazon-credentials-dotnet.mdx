...
<Figure src="/images/aws-credentials-iam-console-admin-users.jpg" caption="## Connecting to AWS Services" />
...
<BlogLink
  ...
  featureImage="/images/security_lock.jpg"
/>
