...
date: '2022-04-28'
feature_image: /content/images/secure-key.jpg
tags:
  - AWS
excerpt: >-
  Learn different ways to set up and manage credentials and sensitive
  information when building .NET applications on AWS. We will also touch upon
  some of the tools and utilities that I have set up on my local development
  machine to make working with AWS easier.
---
...
<ImageCard src="/content/images/aws-credentials-iam-console-admin-users.jpg" alt="Create administrator accounts and use them instead of the root user account." />
...
<ImageCard src="/content/images/aws-credentials-aws-toolkit-sdk-store-windows.jpg" alt="Windows Only SDK Store allows storing encrypted credentials" />
...
<BookmarkCard href="/blog/aws-parameter-store" title="AWS Parameter Store For The .NET Developer: How to Easily Get Started" description="Learn how to get started with AWS Parameter Store and use it from a .NET application to store and retrieve configuration data. Understand how parameters are versioned and how to use labels and hierarchies to manage parameters better. Seamlessly use the built-in .NET Configuration capabilities to loa" icon="/favicon.ico" />
