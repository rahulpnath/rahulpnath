---
title: >-
  Escaping the Cancel Button Trap: AbortController and CancellationToken in
  ASP.NET API
slug: abortcontroller-cancellationtoken-dotnet
date: '2024-08-02'
feature_image: /content/images/2024/08/Cancel-Button-Trap.png
tags:
  - Dotnet
excerpt: >-
  Canceling a long-running process from a UI form doesn't mean the server has
  stopped processing the work. 


  Let's learn how to use AbortController and CancellationTokens to help cancel a
  task all the way down when building ASP NET applications.
---
_Imagine this.._
...
<EmbedCard src="https://www.youtube.com/embed/tSEc5hXx1TM?feature=oembed" title="Abort Controller and Cancellation Tokens | Cancel Your Work All the Way | ASP NET" />
...
Thanks to AWS for sponsoring this post in my [ASP NET Series](/blog/tag/asp-net/).
...
<ImageCard src="/content/images/2024/07/image-27.png" alt="A simple UI form that allows a user to upload files to Amazon S3 using an API endpoint." caption="A simple UI form that allows a user to upload files to Amazon S3 using an API endpoint." />
