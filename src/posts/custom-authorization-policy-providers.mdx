...
The above code looks for policies named 'Admin' and 'Manager', which we registered on application startup using the _services.AddAuthorization_ call (as shown in the [previous post](__GHOST_URL__/blog/dot-net-core-api-and-azure-ad-groups-based-access/)).
