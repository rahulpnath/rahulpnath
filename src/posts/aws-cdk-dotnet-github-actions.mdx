...
date: '2024-12-04'
feature_image: /content/images/2024/12/CDK---GitHub-Actions.png
tags:
  - AWS
  - DevOps
excerpt: >-
  Let's learn how to set up a build-deploy pipeline on GitHub Actions to
  automate infrastructure management and deploy resources on AWS for our .NET
  application.
---
...
<EmbedCard src="https://www.youtube.com/embed/IvxWDFb-fSs?feature=oembed" title="AWS CDK GitHub Actions | Getting Started | AWS CDK SERIES" />
...
<ImageCard src="/content/images/2024/12/image-1.png" alt="GitHub Actions VS Code extension helps manage workflows, manage secrets, provides IntelliSense etc making it easy to author workflows from the editor." caption="GitHub Actions VS Code extension helps manage workflows, manage secrets, provides IntelliSense etc making it easy to author workflows from the editor." />
...
<ImageCard src="/content/images/2024/12/image.png" alt="GitHub Secrets to manage sensitive keys like the AWS Secret and access key" caption="GitHub Secrets to manage sensitive keys like the AWS Secret and access key" />
...
<BookmarkCard href="/blog/aws-cdk-dotnet/" title="AWS CDK For The .NET Developer" description="AWS CDK simplifies Cloud Infrastructure management. CDK lets you define AWS resources using first-class programming concepts. It translates your code into AWS CloudFormation templates, which can be used to provision AWS resources for your application. Let’s get started using .NET and C#." icon="/content/images/icon/logo-512x512-12.png" />
