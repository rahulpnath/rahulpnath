...
date: '2018-07-24'
feature_image: /content/images/content-security-policy.png
tags:
  - Programming
...
<ImageCard src="/content/images/content-security-policy.png" alt="Content Security Policy" />
...
<ImageCard src="/content/images/https_csp_fiddler_script.png" alt="Fiddler Script to update CSP" />
```javascript
...
<ImageCard src="/content/images/https_csp_fiddler_rule_collector.png" alt="Fiddler CSP Rule Collector" />
...
<ImageCard src="/content/images/csp_report_uri_dashboard.png" alt="Report Uri Dashboard" />
