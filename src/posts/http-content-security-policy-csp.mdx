...
feature_image: "/images/content-security-policy.png"
tags: ["Programming"]
excerpt: "Learn about HTTP Content Security Policy (CSP), how it protects your site from XSS and data injection attacks, and how to set up CSP headers for improved web security."
---
...
However if all you want is to play around with the CSP header and don't have access to your Web server or the configuration file, you can still test these headers. You can inject in the headers into the response using a [Web Proxy like Fiddler](/posts/fiddler-free-web-debugging-proxy/)
...
![Fiddler Script to update CSP](/images/https_csp_fiddler_script.png)
...
![Fiddler CSP Rule Collector](/images/https_csp_fiddler_rule_collector.png)
...
![Report Uri Dashboard](/images/csp_report_uri_dashboard.png)
