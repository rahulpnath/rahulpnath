...
excerpt: >-
  Templates/Scaffolding is something that we are all used to nowadays, given
  that we use an IDE for development. Visual Studio is one popular IDE, that is
...
<Figure src="/images/yo_ko.png" caption="**Project Structure**" />
...
<Figure src="/images/yo_ko_app.png" caption="**Adding New Components**" />
