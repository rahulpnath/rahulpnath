...
date: '2016-09-12'
feature_image: /content/images/blog_scheduled.png
tags:
  - DevOps
  - Blogging
...
<ImageCard src="/content/images/blogtrigger_scheduler_url_error.png" alt="Azure Scheduler Encoded URL error" />
...
<ImageCard src="/content/images/blog_scheduled.png" alt="Automatic Deployment of Future Posts With Octopress" caption="Scheduler triggers TravisCI build. For details on how TravisCI is set up check Continuos Delivery of Octopress Blog Using TravisCI and Docker" />
...
<ImageCard src="/content/images/blog_ifttt.png" alt="Trigger Buffer Email When New Post is Published" />
...
_[My Morning Routine](/blog/morning-routine/) was the first posts to be deployed using the schedule._
