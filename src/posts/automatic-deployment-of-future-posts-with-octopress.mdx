...
_Scheduler triggers TravisCI build. For details on how TravisCI is set up check [Continuos Delivery of Octopress Blog Using TravisCI and Docker](/posts/continuos-delivery-of-octopress-blog-using-travisci-and-docker/)_
...
_[My Morning Routine](/posts/morning-routine/) was the first posts to be deployed using the schedule._