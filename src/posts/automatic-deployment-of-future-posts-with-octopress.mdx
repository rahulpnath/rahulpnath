...
_Scheduler triggers TravisCI build. For details on how TravisCI is set up check [Continuos Delivery of Octopress Blog Using TravisCI and Docker](/blog/continuos-delivery-of-octopress-blog-using-travisci-and-docker/)_
