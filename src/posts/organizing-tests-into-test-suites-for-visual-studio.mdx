...
excerpt: >-
  While working with large code base, that has a lot of tests (unit, integration, acceptance etc), running all of them every time we make a small change (if you are...
tags:
  - Productivity
  - Testing
---
...
<Figure src="/images/geek_productivity.jpg" caption="## Test Traits" />
...
<Figure src="/images/vs_tre.png" caption="### Tests Settings File" />
