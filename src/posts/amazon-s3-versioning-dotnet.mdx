...
date: "2024-07-11T02:44:21.000Z"
feature_image: "/images/Enable-S3-Versioning.png"
tags: ["AWS"]
excerpt: "Amazon S3 versioning is a powerful feature that allows you to preserve, retrieve, and restore every version of every object in your bucket.   In this post, let’s explore S3 versioning and how to use it when building .NET applications."
...
AWS console showing an S3 bucket with versioning disabled, which is the default choice.
...
AWS Console showing S3 bucket with bucket versioning turned on.
...
__Every object written to an S3 bucket has an associated__ [_`_VersionId_`_](https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html#version-ids)__. For a non-versioned bucket, this is set to null by default.__
...
AWS Console showing an S3 bucket with multiple versions of an object.
