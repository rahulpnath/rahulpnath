...
<Figure src="/images/image-1.png" caption="AWS console showing an S3 bucket with versioning disabled, which is the default choice." />
...
<Figure src="/images/image-2.png" caption="AWS Console showing S3 bucket with bucket versioning turned on." />
...
<Figure src="/images/image-3.png" caption="AWS Console showing an S3 bucket with multiple versions of an object." />
