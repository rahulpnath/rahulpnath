...
You can see these resources in the Amazon Console or from Visual Studio if you have [AWS Toolkit installed and set up.](/posts/amazon-credentials-dotnet/)
