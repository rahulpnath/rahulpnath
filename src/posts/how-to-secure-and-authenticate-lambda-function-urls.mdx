...
date: "2022-10-31T07:23:29.000Z"
feature_image: "/images/AWS-Lambda-Function-URLs-Auth.png"
tags: ["AWS","Lambda"]
---

_This article is sponsored by AWS and is part of my [AWS Series](/posts/category/aws/)._

In a previous blog post, [Function URLs - Quick and Easy way to Invoke AWS Lambda Functions over HTTP](/posts/function-urls-in-aws-lambda-dotnet/), we learned how to expose and invoke Lambda functions over an HTTP endpoint.
...
![](/images/http_client_web.jpg)

](/posts/are-you-using-httpclient-in-the-right-way/)
