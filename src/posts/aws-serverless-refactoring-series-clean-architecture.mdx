...
_This is Part 1 of the [AWS Serverless Refactoring Series](/posts/aws-serverless-refactoring-series/), where I refactor the default AWS Serverless Application template to a more maintainable and easy to extend architecture._
