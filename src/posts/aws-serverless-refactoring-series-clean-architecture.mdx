...
date: "2021-05-03T14:10:00.000Z"
feature_image: "/images/aws_serverless_refactor_project.jpg"
tags: []
---

_This is Part 1 of the [AWS Serverless Refactoring Series](__GHOST_URL__/blog/aws-serverless-refactoring-series/), where I refactor the default AWS Serverless Application template to a more maintainable and easy to extend architecture._
