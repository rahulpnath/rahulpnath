...
excerpt: >-
  ...
  Series(GHOSTURL/tag/aws/).  AWS Lambda is a compute service that lets you run
...
<Figure src="/images/image.png" caption="Use this and follow the GUI dialog to deploy the Lambda Function." />
...
<BlogLink
  href="/blog/amazon-api-gateway-http-apis/"
