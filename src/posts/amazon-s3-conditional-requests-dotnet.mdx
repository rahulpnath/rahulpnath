...
date: '2024-10-04'
feature_image: /content/images/2024/10/Copy-of-Amazon-S3-Versioning.png
tags:
  - AWS
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/DGLPNKPmZJA?feature=oembed" title="Amazon S3 Conditional Requests  | .NET ON AWS | AWS Serverless | Amazon" />
...
<BookmarkCard href="/blog/amazon-s3-versioning-dotnet/" title="Enable Versioning on Your Amazon S3 Buckets" description="Amazon S3 versioning is a powerful feature that allows you to preserve, retrieve, and restore every version of every object in your bucket. In this post, let’s explore S3 versioning and how to use it when building .NET applications." icon="/content/images/icon/logo-512x512-1.png" />
