...
excerpt: >-
  !visual studio debug not working(/images/vsdebugnotworking.png)  Quite a few days back,I faced a peculiar problem :).Visual Studio was not having the green play button(the one for Start Debugging) enabled.No way...
tags:
  - Dotnet
---
