...
<Figure src="/images/image-7.png" caption="LocalStack GUI with one local stack instance running." />
...
<Figure src="/images/image-6.png" caption="Create DynamoDB Table in LocalStack using the GUI tool" />
...
<BlogLink
  ...
  authorImage="/images/logo-512x512-7.png"
