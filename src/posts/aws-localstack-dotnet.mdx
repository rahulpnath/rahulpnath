...
date: '2024-11-21'
feature_image: /content/images/2024/11/LocalStack.png
tags:
  - AWS
excerpt: >-
  LocalStack is a fully functional local AWS cloud stack that lets you emulate
  AWS services directly on your machine. Let's learn how to set up and run your
  .NET application locally on LocalStack.
---
...
<EmbedCard src="https://www.youtube.com/embed/zqwgDQjxGUg?feature=oembed" title="AWS LocalStack + .NET | .NET ON AWS | AWS Serverless | Amazon" />
...
<ImageCard src="/content/images/2024/11/image-7.png" alt="LocalStack GUI with one local stack instance running." caption="LocalStack GUI with one local stack instance running." />
...
In a future post, we will explore how you can seamlessly provision resources using [AWS CDK](/blog/aws-cdk-dotnet/).
...
<ImageCard src="/content/images/2024/11/image-6.png" alt="Create DynamoDB Table in LocalStack using the GUI tool" caption="Create DynamoDB Table in LocalStack using the GUI tool" />
