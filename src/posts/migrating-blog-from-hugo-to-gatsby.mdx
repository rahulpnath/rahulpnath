...
I have migrated in the past from [Blogspot](https://rahulpnath.blogspot.com) to [Wordpress.com](https://rahulpnath.wordpress.com), then to [self-hosted Wordpress](/posts/azure-web-sites-moving-wordpress-to-cloud/).

It didn't end there. I moved again to a Static generator because I thought [that's all a blog needs](/posts/static-generator-is-all-a-blog-needs-moving-to-octopress/).

No, not Hugo. Not there yet!

I moved it to [Octopress](/posts/static-generator-is-all-a-blog-needs-moving-to-octopress/) and from there finally to [Hugo](/posts/migrating-octopress-to-hugo/).
