...
feature_image: "/images/net_pdf.jpg"
tags: ["Dotnet","Azure"]
---
...
Previously I had written about [dynamically generating a large PDF from website contents](/posts/generating-a-large-pdf-from-website-contents/). The PDF library I used that then, did have the limitation of not being able to run on Azure Web App. It was because of [Azure sandbox restrictions](https://github.com/projectkudu/kudu/wiki/Azure-Web-App-sandbox#pdf-generation-from-html).

<iframe src="https://www.youtube.com/embed/fp-Rc3qNDdA" />
