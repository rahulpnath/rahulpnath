...
<Figure src="/images/cors_url_structure.jpg" caption="So if any one of them (Scheme, Host, or Port) is different, it's treated as a different origin." />
...
<Figure src="/images/cors_request_headers.jpg" caption="### Configurable Origins" />
