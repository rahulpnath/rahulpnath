...
![StyleCop git hook failing commit in console](/images/code_formatting_git_hook_console.png)

![StyleCop git hook failing commit in Source Tree](/images/code_formatting_git_hook_sourcetree.png)
