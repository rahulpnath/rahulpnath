...
<Figure src="/images/codeformatting_column_guide.png" caption="### **Aligning Function Parameters**" />
...
<Figure src="/images/code_formatting_git_hook_console.png" caption="![StyleCop git hook failing commit in Source Tree](/images/code_formatting_git_hook_sourcetree.png)" />
