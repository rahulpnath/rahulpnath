...
I will use an API built over [AWS DynamoDB](/posts/amazon-dynamodb-dotnet-developer/), and [AWS Lambda to host the API](/posts/asp-net-core-on-aws-lambda/).
...
](/posts/amazon-dynamodb-dotnet-developer/)
...
![](/images/AWS-Lambda-Function-URLs-Auth.png)

](/posts/asp-net-core-on-aws-lambda/)
