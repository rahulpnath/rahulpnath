...
<Figure src="/images/amazon-sns-create-topic.jpg" caption="### SNS & .NET" />
...
<Figure src="/images/amazon-sns-lambda-permissions.jpg" caption="Under the Lambda → Triggers, you can add a new Trigger and set up the integration with Amazon SNS." />
...
<Figure src="/images/amazon-sns-subscription-filter-policy.jpg" caption="Filter Policies JSON structure supports different filtering capabilities" />
...
<Figure src="/images/amazon-sns-subscription-dlq.jpg" caption="Dead Letter Queue's (DLQ) are attached to a SNS Subscription." />
