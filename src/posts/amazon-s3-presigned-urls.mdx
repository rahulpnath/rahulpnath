...
date: '2025-03-05'
feature_image: /content/images/2025/03/AWS-S3-Presigned-URLs.png
tags:
  - AWS
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/ZhhZm8nlMWE?feature=oembed" title="Amazon S3 Presigned URLs | .NET ON AWS | AWS Serverless | Amazon" />
...
<ImageCard src="/content/images/2025/03/image.png" alt="Navigate to the file in Amazon S3 Console, and under Object actions → Share with a presigned URL, you can generate a URL to share the file with anyone" caption="Navigate to the file in Amazon S3 Console, and under Object actions → Share with a presigned URL, you can generate a URL to share the file with anyone" />
...
<ImageCard src="/content/images/2025/03/image-1.png" alt="Time interval until the presigned URL expires when creating a presigned URL from AWS Console." caption="Time interval until the presigned URL expires when creating a presigned URL from AWS Console." />
...
<BookmarkCard href="/blog/amazon-s3-dotnet/" title="Amazon S3 For the .NET Developer: How to Easily Get Started" description="Learn how to get started with Amazon S3 from a .NET Core application. We will learn how to store and retrieve data from the storage, important concepts to be aware of while using S3." icon="/content/images/icon/logo-512x512-19.png" />
...
<BookmarkCard href="/blog/amazon-credentials-dotnet/" title="Learn How To Manage Credentials When Building .NET Application on AWS" description="Learn different ways to set up and manage credentials and sensitive information when building .NET applications on AWS. We will also touch upon some of the tools and utilities that I have set up on my local development machine to make working with AWS easier." icon="/content/images/icon/logo-512x512-20.png" />
...
<BookmarkCard href="/blog/asp-net-core-cors-demystified/" title="Understand CORS and Learn How to Enable it for Your ASP NET API" description="Cross Origin Resource Sharing or CORS in short is a W3C standard that allows a server to relax the same-origin policy. Learn more about CORS, how to enable it for an ASP NET Web API, Preflight requests and more." icon="/content/images/icon/logo-512x512-21.png" />
...
<ImageCard src="/content/images/2025/03/image-2.png" alt="" />
