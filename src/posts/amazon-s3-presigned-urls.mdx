...
<Figure src="/images/image-1.png" caption="Time interval until the presigned URL expires when creating a presigned URL from AWS Console." />
...
<Figure src="/images/image-2.png" caption="For now I have enabled all origins by using the `*` wildcard operator." />
