...
**PRO TIP**: _Have a script file as part of the source code to set up such variables. Make sure the sensitive values are shared securely (and [not via the source control](__GHOST_URL__/blog/keeping-sensitive-configuration-data-out-of-source-control/))_
