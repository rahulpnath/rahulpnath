...
<Figure src="/images/image-1.png" caption="Create a new Amazon MQ broker using the RabbitMQ broker type." />
...
<Figure src="/images/image-3.png" caption="Configure RabbitMQ setting in Amazon MQ." />

Review and create the RabbitMQ broker instance.

<Figure src="/images/image-5.png" caption="RabbitMQ broker instance up and running and the details as from the AWS console." />
...
<Figure src="/images/rabbitmq-hello.gif" caption="Send and Receive applications in action, working with Amazon MQ RabbitMQ." />
