...
<Figure src="/images/keyvaultportal_menu_option.png" caption="## Creating Key Vault" />
...
<Figure src="/images/keyvaultportal_access_policy.png" caption="You can specify the Key Permissions and the Secret Permissions that the ServicePrincipal." />

<Figure src="/images/keyvaultportal_secretpermissions.png" caption="### Keys and Secrets" />
