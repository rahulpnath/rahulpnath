...
feature_image: /images/cypress_react_json_server_typescript.jpg
excerpt: >-
  For the past couple of weeks, I have been playing around with Cypress and been
  enjoying the experience.
  Cypress(https://docs.cypress.io/guides/overview/why-cypress.htmlIn-a-nutshell)
  is a next-generation front end testing tool built for the modern...
tags:
  - Testing
---
...
<Figure src="/images/cypress_cra_jsonServer_folder_structure.jpg" caption="Start writing Cypress tests now!" />
