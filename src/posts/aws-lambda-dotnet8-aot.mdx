...
<Figure src="/images/image.png" caption="AWS Lambda Function Native AOT project template in Visual Studio for .NET 8." />
...
<Figure src="/images/image-1.png" caption="Publish Lambda Function using .NET 8 native AOT uses docker to generate the deployable packages." />
