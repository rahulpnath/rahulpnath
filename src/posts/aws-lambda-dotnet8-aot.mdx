...
date: '2024-11-05'
feature_image: /content/images/2024/11/Lambda-.NET-8.png
tags:
  - AWS
  - Lambda
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/fQHVctOp4sg?feature=oembed" title="AWS Lambda on .NET 8 | Getting Started | AWS LAMBDA SERIES" />
...
> _With Native AOT, Benchmarks show up to 86% improvement in cold start times by eliminating the JIT compilation_ in the blueprints and templates from 256 MB to 512 MB.
...
<ImageCard src="/content/images/2024/11/image.png" alt="AWS Lambda Function Native AOT project template in Visual Studio for .NET 8." caption="AWS Lambda Function Native AOT project template in Visual Studio for .NET 8." />
...
<ImageCard src="/content/images/2024/11/image-1.png" alt="Publish Lambda Function using .NET 8 native AOT uses docker to generate the deployable packages." caption="Publish Lambda Function using .NET 8 native AOT uses docker to generate the deployable packages." />
