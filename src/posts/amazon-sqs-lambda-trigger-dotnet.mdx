...
date: '2022-09-21'
feature_image: /content/images/amazon-sqs-lambda-triggers-dotnet.jpg
tags:
  - AWS
  - Lambda
excerpt: >-
  Learn how to process SQS messages from AWS Lambda Function. We will learn how
  to set up and trigger a .NET Lambda Function using SQS and the various
...
<EmbedCard src="https://www.youtube.com/embed/0V4aeT7oONo" />
...
<BookmarkCard href="/blog/amazon-sqs" title="Amazon SQS For the .NET Developer: How to Easily Get Started" description="Learn how to get started with Amazon SQS and use it from a .NET Application. We will learn how to send and receive messages, important properties,and concepts that you need to know when using SQS." icon="/favicon.ico" />
...
To add a Lambda trigger from the Lambda function, navigate the Lambda Function. Under Configuration → Triggers, select the ‘_Add Trigger’_ button.

<ImageCard src="/content/images/aws-lambda-sqs-trigger.jpg" alt="To add a Lambda trigger, select the Add trigger option under Configuration → Triggers." />
...
<ImageCard src="/content/images/aws-lambda-sqs-trigger-add.jpg" alt="Select SQS as the source and the SQS Queue ARN details. When a new message comes to the SQS queue, our .NET Lambda Function will be triggered. " />
...
<ImageCard src="/content/images/aws-lambda-sqs-trigger-execution-role.jpg" alt="Select the Execution Role under Configuration → Permissions to update the IAM Policies for the .NET Lambda Function." />
...
<ImageCard src="/content/images/aws-lambda-sqs-trigger-iam-policies.jpg" alt="Set up inline IAM Policy for the .NET Lambda Function to connect with the SQS. It requires permissions to ReceiveMessage, DeleteMessage and to GetQueueAttributes." />
...
<ImageCard src="/content/images/aws-lambda-sqs-trigger-send-message.jpg" alt="Send a test message from the SQS in the AWS Console" />
...
<ImageCard src="/content/images/aws-lambda-sqs-trigger-configurations.jpg" alt="The SQS Lambda trigger provides a few configurable options, mainly Batch Size and Batch Window. This affects how the messages are sent to the Lambda function." />
