...
feature_image: /images/amazon-sqs-lambda-triggers-dotnet.jpg
excerpt: >-
...
<Figure src="/images/aws-lambda-sqs-trigger.jpg" caption="It prompts a new window with an option to select the source for the trigger." />
