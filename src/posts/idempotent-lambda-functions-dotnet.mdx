...
The Lambda Function sample uses [Lambda Annotations Framework](/posts/lambda-annotation-framework-crud-api/) , which makes it extremely easy to build Lambda Functions in .NET.
