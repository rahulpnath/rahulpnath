...
date: 2017-01-25
feature_image: /images/cmder.png
excerpt: >-
  I have been using Cmder as my command line for around two years and been loving it. I am not a super user of the command line, but try to...
tags:
  - Tools
  - Productivity
---
<iframe src="https://www.youtube.com/embed/fpxx8hlNTzc" />
...
\`\`\` text // Powershell Administrator Task \*PowerShell -ExecutionPolicy Bypass -NoLogo -NoProfile -NoExit -Command "Invoke-Expression '. ''%ConEmuDir%\\..\\profile.ps1'''" -new\_console:d:"%USERPROFILE%" \`\`\`
