...
[__Context__](https://docs.aws.amazon.com/cdk/v2/guide/context.html) __values are key-value pairs that can be associated with an app, stack, or construct. They may be supplied to your app from a file (usually either__ _`cdk.json`_ __or__ _`cdk.context.json`_ __in your project directory) or on the command line.__
