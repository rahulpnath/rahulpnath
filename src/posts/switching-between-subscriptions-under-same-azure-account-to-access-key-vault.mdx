...
date: '2017-03-02'
feature_image: /content/images/powershell_azurermcontext.png
tags:
  - Azure
excerpt: >-
  ...
  subscriptions.
---
<ImageCard src="/content/images/powershell_azurermcontext.png" alt="Azure Powershell Get-AzureRmContext" />
