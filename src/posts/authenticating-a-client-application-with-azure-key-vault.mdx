...
date: '2015-03-06'
feature_image: /content/images/default_ad_settings.PNG
tags:
  - Azure
excerpt: >-
  ...
  activities.
---
> Please check [here](/blog/how-the-deprecation-of-switch-azuremode-affects-azure-key-vault/) for scripts using the latest PowerShell cmdlets and check out the new [Visual Studio Connected Service feature](/blog/azure-key-vault-as-a-connected-service-in-visual-studio-2017/).
...
<ImageCard src="/content/images/default_ad_settings.PNG" alt="Default Active Directory under Settings" />
...
<ImageCard src="/content/images/default_ad.PNG" alt="Create an Application under default" />
...
<ImageCard src="/content/images/ad_application_configure.PNG" alt="AD Application Configure" />
...
<ImageCard src="/content/images/ad_application_keys.PNG" alt="AD Application Secret Generation" />
...
```
<EmbedCard src="https://www.youtube.com/embed/51Qmk3TQJ44" />
...
```
<EmbedCard src="https://www.youtube.com/embed/JbshGF4ZwGE" />
