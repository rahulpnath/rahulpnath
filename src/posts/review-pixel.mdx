...
*   **Camera** _Pixel takes brilliant photos in bright light, low light, and any light._ The camera is awesome and at times is a good replacement for your [DSLR](__GHOST_URL__/blog/photography-learning-to-click/). With Pixel, Google also provides unlimited original quality storage for all photos and videos.
