...
*   **Fingerprint sensor** The fingerprint sensor on the back allows you to unlock the phone and specific apps and also authorize purchases. [1Password](/posts/password-manager-get-one-if-you-havent-already/) is integrated with the sensor which enables me to unlock it using the sensor. I no longer need to type in my long master password every time I use 1Password.
*   **Camera** _Pixel takes brilliant photos in bright light, low light, and any light._ The camera is awesome and at times is a good replacement for your [DSLR](/posts/photography-learning-to-click/). With Pixel, Google also provides unlimited original quality storage for all photos and videos.
...
*   [Todoist](/posts/todoist-manage-your-todo-list/): My ToDo List
*   [Feedly](/posts/feedly-one-stop-reading-place/): For all my RSS feeds
*   [Pocket](/posts/pocket-offline-reading-made-easy/): For offline reading and read later
*   [1Password](/posts/password-manager-get-one-if-you-havent-already/): Password Manager
*   [Buffer](/posts/buffer-smarter-social-sharing/): To schedule articles to all social networks
*   [Rescue Time](/posts/rescue-time-track-your-time/): Automatically tracks where I spent time on mobile
*   [Strava, Runtastic & Garmin Connect](/posts/three-months-to-a-half-marathon/): Tracking my runs and exercises
...
*   [JotterPad](/posts/optimizing-octopress-workflow-for-new-posts/): Write articles for blog in markdown format
*   [Google Indic Keyboard](/posts/how-to-setup-google-indic-keyboard-on-your-android-phone/): Writing in my native language
*   Gmail & Outlook: Emails
*   Youtube: Videos

#### \*\*Case \*\*

I am using the [Spigen Neo Hybrid](/posts/spigen-awesome-phone-cases/) case for Pixel. It adds extra weight to the phone, but I am used to it from my Nexus as well. The Neo Hybrid provides military grade protection and protects the phone from most falls.
