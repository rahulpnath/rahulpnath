...
date: '2024-04-05'
feature_image: /content/images/2024/04/RABBITMQ-1.png
tags:
  - RabbitMQ
  - AWS
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/2x2nHN8V0cg?feature=oembed" title="HEADERS EXCHANGE in RabbitMQ | RabbitMQ from DOTNET | Amazon MQ" />
...
<ImageCard src="/content/images/2024/04/image.png" alt="Sender specifies the header attributes and associated values when sending messages to the Exchange." caption="Sender specifies the header attributes and associated values when sending messages to the Exchange." />
...
<ImageCard src="/content/images/2024/04/image-1.png" alt="x-match binding argument specifies whether all header attributes must match or any one of the header attributes must match." caption="x-match binding argument specifies whether all header attributes must match or any one of the header attributes must match." />
...
<ImageCard src="/content/images/2024/04/image-2.png" alt="" />
...
<ImageCard src="/content/images/2024/04/image-3.png" alt="RabbitMQ Management Console showing the Headers Exchange, Queues and Bindings set up." caption="RabbitMQ Management Console showing the Headers Exchange, Queues and Bindings set up." />
