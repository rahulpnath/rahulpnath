...
<Figure src="/images/image.png" caption="Sender specifies the header attributes and associated values when sending messages to the Exchange." />
...
<Figure src="/images/image-3.png" caption="RabbitMQ Management Console showing the Headers Exchange, Queues and Bindings set up." />
