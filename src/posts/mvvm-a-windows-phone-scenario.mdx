...
date: "2013-07-26T05:21:51.000Z"
feature_image: ""
tags: ["Dotnet"]
excerpt: "A practical guide to implementing MVVM in Windows Phone apps, covering common scenarios, architectural patterns, and tips for using MVVM Light toolkit."
---

With multiple platforms/devices, embracing the same technology, common architectural patterns become more popular as they provide us with what we want the most – \*\*Reusability. \*\*MVVM has turned out to be a must use architectural pattern while developing for Windows phone/Windows 8 store apps. I had blogged on this, [Why MVVM matters](/posts/mvvm-does-it-really-matter/).
...
**Edit**: Check out [MVVM – A Windows Phone Scenario – Part 2](/posts/mvvm-a-windows-phone-scenario-part-2/) for the rest of the scenarios