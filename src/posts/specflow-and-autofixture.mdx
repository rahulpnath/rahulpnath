...
date: '2020-08-04'
feature_image: /content/images/random_data.jpg
tags:
  - Testing
...
Populating data is an integral part of writing tests. Most of the time, we are forced to set up much more data than we care about for a test. This might be because of validation on an API endpoint, a [constructor forcing you to give valid values for all the properties](/blog/constructor-and-constraints/). Setting up these unnecessary data pollutes the tests, makes writing tests less enjoyable. It also makes the tests tightly coupled and [hard to refactor](/blog/tag/refactoring/).
...
<BookmarkCard href="/blog/populating-data-for-tests" title="Populating Data for Tests" description="Different scenarios of test data generation." icon="/favicon.ico" />
...
<EmbedCard src="https://www.youtube.com/embed/videoseries?list=PL59L9XrzUa-mItWClbGuMEK5oQpU2onCq" />
...
I can still have the Customer instance injected via the constructor and override just the FirstName and LastName properties, as shown above. AutoFixture [allows a lot of customization and extensions](/blog/populating-data-for-tests/) to configure how objects get created. You can take advantage of it with SpecFlow, by overriding the fixture used in the `DomainDataAutoPopulatedSource` class.
...
_You can find the [example source code used in this post here](https://github.com/rahulpnath/Blog/tree/master/SpecFlow.AutoFixture)_
