...
date: '2023-03-08'
feature_image: /content/images/2023/03/DynamoDB-Custom-Converters.png
tags:
  - AWS
  - DynamoDB
---
...
<EmbedCard src="https://www.youtube.com/embed/Uq1DDQqpUxk?feature=oembed" title="AWS DynamoDB CONVERTERS| .NET ON AWS | AWS Serverless | Amazon" />
...
> _.NET Complex Types with a default constructor is automatically serialized to JSON object_.
...
**_The only thing to ensure is that the class has a default constructor._**
...
When using Enumeration Types in .NET, they are automatically converted into their equivalent [underlying type value (by default _int_).](https://aws.amazon.com/blogs/developer/dynamodb-datamodel-enum-support/)
...
For example, I want to save the `Temperature` as a custom string in DynamoDB - _20°C, 35_°F, etc.
