...
<Figure src="/images/aws_serverless_template_default_items.jpg" caption="### AWS Serverless Application Model (SAM)" />
...
<Figure src="/images/aws_serverless_cloudformation_s3.jpg" caption="## Web API using Azure Lambda, API Gateway, and DynamoDB" />
