...
[AWS Lambda's](/posts/aws-lambda-net-core/) are the stepping stones to building a Serverless application in AWS.
...
<iframe src="https://www.youtube.com/embed/iLo8svHzD\_g" />
...
As shown below, it contains the same set of files as we saw in the [previous post on getting started with AWS Lambda](/posts/aws-lambda-net-core/) with the addition of one new file `serverless.template` ;which is the AWS SAM template file.
