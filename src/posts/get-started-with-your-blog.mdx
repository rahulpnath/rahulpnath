...
excerpt: >-
  If you are a programmer and don’t have a blog, then there is no better time
  than now to start one. Every developer should have a
  blog(http://channel9.msdn.com/Shows/HanselminutesOn9/Hanselminutes-on-9-Social-Networking-for-Developers-Part-1-Every-Developer-Needs-a-Blog),
  for a very...
tags:
  - Blogging
---
