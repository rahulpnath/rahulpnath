...
excerpt: >-
  First things first, Kindly subscribe to my
  channel(https://www.youtube.com/user/rahulnathp).  It's been three-plus years"
  since I published the first YouTube
  video(https://www.youtube.com/watch?v=51Qmk3TQJ44), and here are my
  experiences recording the first
  screencast(GHOSTURL/blog/recording-my-first-screencast/). Things...
tags:
  - Productivity
---
...
<Figure src="/images/youtube-setup-2022-may.jpg" caption="### Equipment Setup" />
