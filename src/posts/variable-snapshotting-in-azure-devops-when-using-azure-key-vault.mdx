...
excerpt: >-
  In the previous post, we saw how to Enable History for Azure DevOps Variable
  Groups Using Azure Key
  Vault(GHOSTURL/blog/azure-devops-variable-groups-history/). However, there is
  one issue with using this approach. Whenever a...
tags:
  - DevOps
  - Azure
---
...
<iframe src="https://www.youtube.com/embed/r1rL_2isCWM" />
