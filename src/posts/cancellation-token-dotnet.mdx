...
feature_image: /images/Cancellation-Token.png
excerpt: >-
  Imagine having a long-running request triggered by a user on your server.  But
  the user is no longer interested in the result and has navigated away from the
  page....
tags:
  - Dotnet
  - AWS
...
<iframe src="https://www.youtube.com/embed/39gIPekzpjs?feature=oembed" />
