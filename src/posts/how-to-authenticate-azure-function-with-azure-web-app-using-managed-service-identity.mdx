---
title: >-
  How to Authenticate and Authorize Azure Function with Azure Web App Using
  Managed Service Identity (MSI)
slug: >-
  how-to-authenticate-azure-function-with-azure-web-app-using-managed-service-identity
date: '2019-05-20'
feature_image: /content/images/azure_function_msi.jpg
tags:
  - Azure
---
...
<EmbedCard src="https://www.youtube.com/embed/r4QFBsT2YE8" />
...
<ImageCard src="/content/images/azure_function_msi.jpg" alt="" /><ImageCard src="/content/images/azure_function_msi_on.jpg" alt="" />
...
To authenticate with the Web API, we need to present a token from the AD application. Any service principal on the AD can authenticate and retrieve token this and so can out Azure Function with the Identity turned on. Usually authenticating with the Azure AD requires a [Client ID/Secret or ClientId?Certificate combination](/blog/authenticating-a-client-application-with-azure-key-vault/). However, with MSI turned on, Azure manages these credentials for us in the background, and we don't have to manage it ourselves. By using the [AzureServiceTokenProvider](https://docs.microsoft.com/en-us/azure/key-vault/service-to-service-authentication) class from the [Microsoft.Azure.Services.AppAuthentication,](https://www.nuget.org/packages/Microsoft.Azure.Services.AppAuthentication) NuGet package helps authenticate an MSI enabled resource with the AD.
...
<EmbedCard src="https://www.youtube.com/embed/HVruBWuKnYw" />
...
<EmbedCard src="https://www.youtube.com/embed/FTpAgSHfu8o" />

  

In a [previous post](/blog/custom-authorization-policy-providers/), we saw how to use Azure AD Groups to provide role-based access. You can add a Service Principal to the AD group either through the portal or code.

<ImageCard src="/content/images/azure_function_msi_add_to_ad_group.jpg" alt="" />
```bash
...
<ImageCard src="/content/images/azure_function_role_based_access.jpg" alt="" />

The Web API can now use these claims from the token to determine what functionality needs to be available for the associated roles. Here is a [detailed post on how to do that using claims based on Groups](/blog/dot-net-core-api-and-azure-ad-groups-based-access/).
