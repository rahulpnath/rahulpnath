...
date: '2023-11-06'
feature_image: /content/images/2023/11/Lambda-Annotations-and-AWS-Services.png
tags:
  - AWS
  - Lambda
excerpt: >-
...
-   [Learn How AWS Lambda Annotations Framework Makes API Gateway Integration Easy](/blog/aws-lambda-annotation-framework/)
-   [Serverless API Development Made Easy: Using AWS Lambda Annotations for CRUD](/blog/lambda-annotation-framework-crud-api/)
-   [How To Set Up Dependency Injection in Lambda Functions Using Annotations Framework](/blog/lambda-annotations-dependency-injection/)

In all the above scenarios we used the Annotations Framework along with building Lambda Functions for the API Gateway.

<EmbedCard src="https://www.youtube.com/embed/RhGQSTVhfls?feature=oembed" title="Lambda Annotations & AWS Services |  .NET ON AWS | Serverless | Amazon" />
...
<BookmarkCard href="/blog/amazon-s3-lambda-triggers-dotnet/" title="Amazon S3 and AWS Lambda Triggers in .NET" description="Amazon S3 raises event notifications when Objects are created and modified. Learn how to use this to trigger Lambda Functions in .NET and the different configuration associated with processing the notification messages." icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
