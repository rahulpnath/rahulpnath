...
date: '2024-10-14'
feature_image: /content/images/2024/10/C--Yield-Statement.png
tags:
  - Dotnet
  - AWS
excerpt: >-
  Iterator methods are methods that create a source for an enumeration. The
  yield method is used to define an iterator method. While you can implement the
  IEnumerable interface, iterators makes it much more easier with the yield
  statement. Let's learn more about this.
---
...
<EmbedCard src="https://www.youtube.com/embed/PHiptFztTQ8?feature=oembed" title="YIELD Statement | Iterator Methods | Exploring C# and DOTNET | Rahul Nath" />
...
This post is sponsored by AWS and is part of my .[NET Series](/blog/tag/dotnet/).
...
<ImageCard src="/content/images/2024/10/image.png" alt="C# compiler generated code for iterator methods using yield statement in .NET." caption="C# compiler generated code for iterator methods using yield statement in .NET." />
...
<BookmarkCard href="/blog/amazon-s3-dotnet/" title="Amazon S3 For the .NET Developer: How to Easily Get Started" description="Learn how to get started with Amazon S3 from a .NET Core application. We will learn how to store and retrieve data from the storage, important concepts to be aware of while using S3." icon="/content/images/icon/logo-512x512-2.png" />
...
<BookmarkCard href="/blog/async-enumerable-dotnet/" title="Getting Started with Async Enumerables: A .NET Developer’s Guide" description="AsyncEnumerables enhances eumeration of collections with asynchronous capabilities. In this post, let’s explore how C# combines ‘yield return’ with ‘async’ and ‘await’ to create efficient asynchronous data streams and how ‘await foreach’ lets us effortlessly consume them." icon="/content/images/icon/logo-512x512-3.png" />
