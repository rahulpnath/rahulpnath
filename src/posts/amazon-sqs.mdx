...
<Figure src="/images/amazon-sqs-create-queue.jpg" caption="## SQS & .NET" />
...
<Figure src="/images/amazon-sqs-receive-messages-console.jpg" caption="You can send and receive messages too from the AWS console." />
