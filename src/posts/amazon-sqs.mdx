...
slug: amazon-sqs
date: '2022-05-12'
feature_image: /content/images/queue.jpg
tags:
  - AWS
excerpt: >-
  Learn how to get started with Amazon SQS and use it from a .NET Application.
  We will learn how to send and receive messages, important properties,and
  concepts that you need to know when using SQS.
---
...
<ImageCard src="/content/images/amazon-sqs-create-queue.jpg" alt="Create Queue from Amazon Console" />
...
<ImageCard src="/content/images/amazon-sqs-receive-messages-console.jpg" alt="You can send and receive messages in  the AWS console" />
...
<EmbedCard src="https://www.youtube.com/embed/oWMQKjHrlJE" />
...
<ImageCard src="/content/images/amazon-sqs-dead-letter-queue.jpg" alt="dead-letter queue configuration for Amazon SQS in the console." />
