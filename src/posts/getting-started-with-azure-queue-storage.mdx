...
<Figure src="/images/azure_storage_account_create_queue.jpg" caption="## Connecting to Azure Queue from .NET" />
...
<Figure src="/images/azure_queue_storage_access_keys.jpg" caption="Azure Queue Storage Access Keys" />
