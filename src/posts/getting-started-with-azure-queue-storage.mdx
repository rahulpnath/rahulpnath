...
<EmbedCard src="https://www.youtube.com/embed/5oTX6srQdOE" />
...
<ImageCard src="/content/images/azure_storage_account_create_portal.jpg" alt="Create an Azure Storage Account from Azure Portal" />

Once created, we can add Queues under the Storage account, as shown below.

<ImageCard src="/content/images/azure_storage_account_create_queue.jpg" alt="Create a Queue under Storage Account from Azure Portal" />
...
<ImageCard src="/content/images/azure_queue_storage_access_keys.jpg" alt="Azure Queue Storage Access Keys" />
...
<ImageCard src="/content/images/azure_queue_storage_new_message.jpg" alt="New Message in Azure Queue" />
...
<ImageCard src="/content/images/azure_storage_explorer.jpg" alt="Azure Storage Explorer to explore Queue storage." />
...
<ImageCard src="/content/images/azure_queue_iam_role_assignment.jpg" alt="Access Control (IAM) Enable Storage Queue Data Contributor Role to access Queue." />
