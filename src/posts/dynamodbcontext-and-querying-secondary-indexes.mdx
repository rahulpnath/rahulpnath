...
date: '2023-07-20'
feature_image: /content/images/2023/07/DynamoDBContext-Indexes.png
tags:
  - AWS
  - DynamoDB
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/tVTMiaXTudc?feature=oembed" title="DynamoDB QUERYING INDEX using HIGH-LEVEL API (DynamoDBContext) | .NET ON AWS | Serverless | Amazon" />
