...
*   [Global Secondary Index (GSI)](/posts/dynamodb-global-secondary-index-gsi/)
*   [Local Secondary Index (LSI)](/posts/local-secondary-index-dynamodb/)
...
You can specify the table name via the `OverriderTableName` property or use the `DynamoDBTable` attribute. Check out the [.NET DynamoDB SDK: Understanding Table Name Conventions and DynamoDBTable Attribute](/posts/dynamodb-net-table/) to learn more.
