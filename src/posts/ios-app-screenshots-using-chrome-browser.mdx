...
<Figure src="/images/ios_screenshots_chrome_all_devices.jpg" caption="### Add Custom Device" />
...
<Figure src="/images/ios_screenshots_iphone_xs_max_chrome.jpg" caption="## Capture Screenshot in Native Resolution" />
