...
date: '2023-08-28'
feature_image: /content/images/2023/08/Lambda-Annotation-Framework---Introduction.png
tags:
  - AWS
  - Lambda
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/qWxjCkqX_lM?feature=oembed" title="Lambda Annotations Framework Introduction | .NET ON AWS | Serverless | Amazon" />
...
-   `RestApi` → Configures Lambda Function to be called from [API Gateway REST API](/blog/amazon-api-gateway-rest-api-introduction/).
-   `HttpApi` → Configures Lambda Function to be called from [API Gateway HTTP API](/blog/amazon-api-gateway-http-apis/).
...
<ImageCard src="/content/images/2023/08/image.png" alt="Screenshot of the Function DLL in JetBrains dotPeek showing the disassembled code of the function generated by the C# source generato." caption="Screenshot of the Function DLL in JetBrains dotPeek showing the disassembled code of the function generated by the C# source generato." />
