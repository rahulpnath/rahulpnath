...
date: 2024-07-29
feature_image: /images/ECS-ASP-NET.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/C8cyryjYn8I?feature=oembed" />
...
<Figure src="/images/image-26.png" caption="Core Concepts of ECS and how they are related" />
...
<Figure src="/images/image-15.png" caption="Publish to AWS option to deploy ASP NET API to ECS Fargate from within Visual Studio" />
...
<Figure src="/images/image-17.png" caption="Visual Studio AWS Toolkit deploy ASP NET to ECS Fargate" />
...
<Figure src="/images/image-18.png" caption="Visual Studio AWS Toolkit specify health check endpoint for ECS Fargate cluster" />
...
<Figure src="/images/image-20.png" caption="Visual Studio AWS Toolkit status of deploying .NET API to ECS with Fargate" />
...
<Figure src="/images/image-19.png" caption="Status of the CloudFormation template being run as part of the CDK deploy step from AWS Toolkit" />
...
<Figure src="/images/image-21.png" caption="ECS Cluster details with 1 service running." />
...
<Figure src="/images/image-22.png" caption="Details of the Service running in our ECS cluster, which has the load balancer attached to it." />

You can also see that the Tasks are running on Fargate instances.

<Figure src="/images/image-23.png" caption="Tasks running as part of the ECS service, which all points to the same Task Definition file." />
...
<Figure src="/images/image-24.png" caption="Task Definition showing the memory, CPU, the docker image used etc." />
...
<Figure src="/images/image-25.png" caption="Clean up all resources created by deleting the entire CloudFormation stack." />