...
date: '2023-12-05'
feature_image: /content/images/2023/12/DynamoDB-TTL.png
tags:
  - AWS
  - DynamoDB
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/X8en0qKiLVs?feature=oembed" title="DynamoDB Time to Live (TTL)  | .NET ON AWS | AWS Serverless | Amazon" />
...
<ImageCard src="/content/images/2023/12/image-3-1.png" alt="The Time to Live (TTL) setting in AWS Console for an existing table is in the Additional Settings section in DynamoDB table details." caption="The Time to Live (TTL) setting in AWS Console for an existing table is in the Additional Settings section in DynamoDB table details." />
...
<ImageCard src="/content/images/2023/12/image-4.png" alt="Specify the TTL attribute name to use in AWS Console and turn on TTL." caption="Specify the TTL attribute name to use in AWS Console and turn on TTL." />
...
<ImageCard src="/content/images/2023/12/image-5.png" alt="AWS Console shows a preview of upcoming items marked for auto-deletion as the time to live expiry is nearing. This is only a subset of items and not an exhaustive list." caption="AWS Console shows a preview of upcoming items marked for auto-deletion as the time to live expiry is nearing. This is only a subset of items and not an exhaustive list." />
...
<BookmarkCard href="/blog/aws-dynamodb-streams-lambda-triggers-dotnet/" title="DynamoDB Streams and AWS Lambda Trigger in .NET" description="DynamoDB Streams capture a time-ordered sequence of events in any DynamoDB table. Let’s learn how to enable DynamoDB Streams, different stream types and how to consumer stream changes from a .NET AWS Lambda Function." icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
