...
![Specify the TTL attribute name to use in AWS Console and turn on TTL.](/images/image-4.png)
...
![](/images/aws-lambda-dynamodb-streams-trigger-dotnet.jpg)

](/posts/aws-dynamodb-streams-lambda-triggers-dotnet/)
