...
feature_image: /images/json_server.jpg
excerpt: >-
  JSON Server(https://github.com/typicode/json-server) is a great way to set up"
  a full fake REST API for front-end development. JSON server can be set up
  literally in '30 seconds' and with no...
tags:
  - Testing
---
...
<iframe src="https://www.youtube.com/embed/yq0S2f3k9zY" />
