...
tags: ["Azure"]excerpt: "Learn how to set up Dependency Injection in Azure Functions using .NET ."
...
If you are new to building Azure Functions, check out my [Azure Functions ⚡ For The .NET Developer](/posts/getting-started-with-azure-functions/) post to quickly get started. I’ll continue using the sample Function I used there and extend it to support Dependency Injection.

<iframe src="https://www.youtube.com/embed/m\_jrALXcrXc" />

Setting Up Azure Function Dependency Injection
----------------------------------------------

The Azure Functions we [wrote earlier](/posts/getting-started-with-azure-functions/) logs to the console. Say we want to do some business-related processing every time we get a message in the queue.
...
The default Function class created by the Visual Studio template (in the [previous example](/posts/getting-started-with-azure-functions/)) is a static method in a static class.
...
<iframe src="https://www.youtube.com/embed/v=5GlgHV\_12-k" />
