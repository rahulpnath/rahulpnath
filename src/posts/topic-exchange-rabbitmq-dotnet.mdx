...
RabbitMQ supports four Exchange Types: Topic Exchange, [**Direct Exchange**](/posts/direct-exchange-rabbitmq-dotnet/)**,** [Fanout Exchange](/posts/fanout-exchange-rabbitmq-dotnet/), [Headers Exchange](/posts/headers-exchange-rabbitmq-dotnet/).
...
_This article is sponsored by AWS and is part of my_ [_RabbitMQ Series_](/posts/tag/rabbitmq/)_._
