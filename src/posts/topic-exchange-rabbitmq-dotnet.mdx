...
<Figure src="/images/image-5.png" caption="AWS MQ RabbitMQ Management Console shows a Topic Exchange with the two bindings using wildcards." />
...
<Figure src="/images/rabbitmq-topic-exchange-demo.gif" caption="RabbitMQ Topic Exchange demo using different wildcard options." />
