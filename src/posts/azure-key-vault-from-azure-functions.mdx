...
<Figure src="/images/azureFunction_create.png" caption="You can view all Azure Functions Apps in the subscription under _More services - Function Apps_" />
...
<Figure src="/images/azureFunction_nuget.png" caption="Executing the function, retrieves the secret details from the Key Vault and logs it as shown below." />
