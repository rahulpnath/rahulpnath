...
date: '2020-11-12'
feature_image: /content/images/build_automation.jpg
tags:
  - Azure
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/p_vySBLni00" />
...
<BookmarkCard href="/blog/cosmos-arm-template" title="How To Create An ARM Template For Cosmos DB" description="Learn how to create an ARM template to deploy Azure Cosmos DB with dynamic containers. With this template you can keep adding containers as you build the application." icon="/favicon.ico" />
...
<ImageCard src="/content/images/cosmos_emulator_linked_files.jpg" alt="Linked ARM Template files in Visual Studio Solution Explorer" />
...
<ImageCard src="/content/images/cosmos_emulator_build_error.jpg" alt="Build error when not running Cosmos Emulator" />
