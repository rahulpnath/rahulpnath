...
tags: ["Azure"]excerpt: "Azure Cosmos Emulator does not support ARM templates. Learn how you can automatically create Database and Containers from an ARM Template to support a seamless development experience."
...
<iframe src="https://www.youtube.com/embed/p\_vySBLni00" />

ARM Templates and Multiple Containers
-------------------------------------

I showed you [how to set up Azure ARM templates to deploy Cosmos DB](/posts/cosmos-arm-template/) in an earlier post.
...
![](/images/arm_template.png)

](/posts/cosmos-arm-template)
