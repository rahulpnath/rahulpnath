...
<BookmarkCard href="/blog/aws-lambda-dotnet-developer/" title="AWS Lambda For The .NET Developer" description="This blog post is a collection of other posts that covers various aspects of AWS Lambda and other services you can integrate with when building serverless applications on Lambda." icon="/content/images/icon/logo-512x512-24.png" />
