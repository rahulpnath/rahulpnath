...
[AWS Lambda Powertools](https://www.youtube.com/playlist?list=PL59L9XrzUa-lVIngBF1OTG1Wxy56_esQB)
...
<BlogLink
  ...
  authorImage="/images/logo-512x512-25.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/Lambda-Lifecycle-2-1.png"
/>
...
<Figure src="/images/image-11.png" caption="Ask the agent the weather for any city, and it will return the weather from our Lambda function." />
