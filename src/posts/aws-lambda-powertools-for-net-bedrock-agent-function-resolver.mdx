...
date: '2025-07-31'
feature_image: /images/2025/07/Copy-of-AWS-Bedrock.png
excerpt: >-
...
<EmbedCard src="https:/www.youtube.com/embed/-0ivGo5iKvY?feature=oembed" title="Getting Started with Bedrock Agent Function in AWS Lambda (.NET) | AI on AWS" />
...
<BookmarkCard href="https:/www.youtube.com/playlist?list=PL59L9XrzUa-lVIngBF1OTG1Wxy56_esQB" title="AWS Lambda Powertools" description="Powertools for AWS Lambda (.NET) is a suite of utilities for AWS Lambda functions to ease the adoption of best practices such as tracing, structured logging,…" icon="/images/icon/favicon_144x144.png" />
...
<BookmarkCard href="/blog/lambda-lifecycle-and-net/" title="Why Should You Care About Lambda Lifecycle As A .NET Developer?" description="The Lambda Lifecycle affects the way we write out Function code. Learn some of the dos and don’ts when building Lambda Functions in .NET because of how Lambda initializes the Function classes." icon="/images/icon/logo-512x512-25.png" />
...
<ImageCard src="/images/2025/07/image-1.png" alt="" />
...
<ImageCard src="/images/2025/07/image-3.png" alt="" />
...
<ImageCard src="/images/2025/07/image-4.png" alt="" />
...
<ImageCard src="/images/2025/07/image-5.png" alt="" />
...
<ImageCard src="/images/2025/07/image-7.png" alt="" />
