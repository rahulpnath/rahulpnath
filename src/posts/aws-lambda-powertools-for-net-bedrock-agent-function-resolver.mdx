...
![](/images/logo-512x512-24.png)Rahul NathRahul Pulikkot Nath

![](/images/AWS-Lambda-1.png)

](/posts/aws-lambda-dotnet-developer/)
...
![](/images/logo-512x512-25.png)Rahul NathRahul Pulikkot Nath

![](/images/Lambda-Lifecycle-2-1.png)
...
Once you have setup the tools and the function, publish the Lambda Function to your [AWS Account](/posts/amazon-credentials-dotnet/).
