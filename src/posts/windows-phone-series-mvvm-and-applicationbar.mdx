...
excerpt: >-
  ApplicationBar on a windows phone, is to provide users of your app with quick access to the most commonly used tasks. For a mail app this would be refresh/new mail,...
tags:
  - Dotnet
---
...
<Figure src="/images/wp_applicationbar_icon_mvvm.png" caption="Hope it helps!!" />