...
tags: ["AWS","Lambda"]excerpt: "Lambda Authorizer is a feature provided by API Gateway that helps us separate the authentication logic from our business logic in our function code. Let's learn how to build a Lambda Authorizer in .NET Core and use it to secure an API Gateway REST API."
...
](/posts/amazon-api-gateway-rest-api-lambda-proxy-integration)
...
We need to set the Authorizer explicitly for each Method endpoint for the API. This is set under the [Method Request section under a Resoruce](/posts/amazon-api-gateway-rest-api-introduction/).
