...
date: '2022-08-03'
feature_image: /content/images/aws-lambda-authorizer-dotnet.jpg
tags:
  - AWS
  - Lambda
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/5kI2wZWp4NU" />
...
<ImageCard src="/content/images/api-gateway-lambda-authorizer-create.jpg" alt="Create a new .NET Lambda Authorizer in API Gateway REST API by providing the name, Lambda function used as the authorizer, and the token type to use. Also, enable token caching if required." />
...
<ImageCard src="/content/images/api-gateway-lambda-authorizer-set-authorizer-for-method.jpg" alt="Set the .NET Lambda Authorizer on REST API Method Request" />
...
<ImageCard src="/content/images/api-gateway-lambda-authorizer-sample-api-request-postman.jpg" alt="Sample API gateway REST API request with the token in HTTP Header for .NET Lambda Authorizer. " />
