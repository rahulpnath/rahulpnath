...
<Figure src="/images/api-gateway-lambda-authorizer-set-authorizer-for-method.jpg" caption="For each method on the REST API, the Authorizer needs to be selected explicitly." />
...
<Figure src="/images/api-gateway-lambda-authorizer-sample-api-request-postman.jpg" caption="## Caching API Gateway Authorizer Responses" />
