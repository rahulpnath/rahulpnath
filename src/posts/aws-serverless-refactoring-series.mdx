...
In the [Going Serverless on AWS For the .NET Developer](/posts/aws-serverless-application/), I showed how to get started with building Serverless Application in AWS. If you are new to AWS Serverless, I recommend reading that and coming back to this post.
...
1.  [How to Move to Clean Architecture?](/posts/aws-serverless-refactoring-series-clean-architecture/)
