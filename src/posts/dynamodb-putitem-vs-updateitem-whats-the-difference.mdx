...
excerpt: >-
  ...
  Series(GHOSTURL/tag/aws/).  DynamoDB provides two primary methods to
  write/modify data in a table: PutItem and UpdateItem.  PutItem...
tags:
  - AWS
  - DynamoDB
---
...
<Figure src="/images/image.png" caption="Snapshot of the item in DynamoDB showing all the properties that are set for the request just made." />
