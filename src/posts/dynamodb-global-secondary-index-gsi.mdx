...
<Figure src="/images/image-8.png" caption="Choose the `Create index` button for the same dialog to create the GSI on an existing table." />

<Figure src="/images/image-6.png" caption="❌" />
