...
date: '2023-06-21'
feature_image: /content/images/2023/06/DynamoDB-GSI.png
tags:
  - AWS
  - DynamoDB
excerpt: >-
  Learn how to create, set up and use a Global Secondary Index (GSI) in DynamoDB
...
<EmbedCard src="https://www.youtube.com/embed/KkbalFKf20A?feature=oembed" title="DynamoDB Global Secondary Index GSI | .NET ON AWS | AWS Serverless | Amazon" />
...
<ImageCard src="/content/images/2023/06/image-3.png" alt="Create Table UI in Amazon AWS Console. Select Customize settings options to create GSI along with creating your DynamoDB Table." />
...
<ImageCard src="/content/images/2023/06/image-4.png" alt="Create Secondary Index option in AWS Console. You can create Global and Local Index when creating the table." />
...
<ImageCard src="/content/images/2023/06/image-5.png" alt="Create GSI dialog which prompty for Partition key, Sort key, Index name and also the Attribure projections." />
...
-   _KEYS\_ONLY_ –  Only the index and the primary keys are projected.
-   _INCLUDE_ – All attributes from `KEYS_ONLY` and attributes you specify additionally.
-   _ALL_ – All attributes are projected.
...
<ImageCard src="/content/images/2023/06/image-8.png" alt="Creating a GSI on existing table from the 'Indexes' tab under the table details in AWS Console." />

Choose the `Create index` button for the same dialog to create the GSI on an existing table.

<ImageCard src="/content/images/2023/06/image-6.png" alt="Create GSI popup with the same required details as when creating on a new table." />
...
<ImageCard src="/content/images/2023/06/image-9.png" alt="" />
...
<BookmarkCard href="/blog/dynamodb-querying-dotnet/" title="5 Ways To Query Data From Amazon DynamoDB using .NET" description="Querying is an essential operation in DynamoDB. It allows you to filter and select items in your database based on your application and user needs. When moving over to DynamoDB from more traditional relational databases like SQL Server, you must understand the different ways you can retrieve data…" icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
...
<BookmarkCard href="/blog/dynamodb-pagination/" title="3 Different Ways To Do Data Pagination from Amazon DynamoDB Using .NET" description="DynamoDB charges for reading, writing, and storing data in your DynamoDB tables. As a rule of thumb, when querying data, you can consider that each record that you retrieve from the database has a direct cost attached to it. Limiting the items you retrieve has a direct impact on saving" icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
