...
excerpt: >-
  How many times have you had to update the API code to return an empty list or
  throw an error to test edge case scenarios?  How do you demo...
tags:
  - Testing
---
