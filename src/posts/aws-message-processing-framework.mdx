...
date: '2024-11-08'
feature_image: /content/images/2024/11/AWS-Message-Processing-Fwk--1-.png
tags:
  - AWS
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/jCrk5M1dcU0?feature=oembed" title="AWS Message Processing Framework for .NET | .NET On AWS | Amazon SQS" />
...
As with everything, we first need to add a NuGet package to use the framework -_AWS.Messaging_ [_🔗_](https://github.com/awslabs/aws-dotnet-messaging)
