...
AWS sponsors this article, which is part of my [.NET on AWS Series](/posts/tag/aws/).
...
![](/images/logo-512x512-11.png)Rahul NathRahul Pulikkot Nath
...
![](/images/logo-512x512-10.png)Rahul NathRahul Pulikkot Nath

![](/images/Copy-of-Amazon-S3-Versioning.png)

](/posts/amazon-s3-conditional-requests-dotnet/)
