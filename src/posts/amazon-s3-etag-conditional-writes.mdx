...
<BlogLink
  ...
  authorImage="/images/logo-512x512-11.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/storage-box-1.jpg"
/>
...
<BlogLink
  href="/blog/amazon-s3-conditional-requests-dotnet/"
  title="Exploring Amazon S3 Conditional Operations From .NET Application"
  description="Amazon S3 now supports conditional requests. You can use conditional requests to add preconditions to your S3 operations. If the precondition is not met it will result in the S3 operation failing. Let’s learn about Conditional Reads and Writes in Amazon S3 and how to use it from .NET"
  authorImage="/images/logo-512x512-10.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/Copy-of-Amazon-S3-Versioning.png"
/>
...
<Figure src="/images/image-18.png" caption="ETag property on an Amazon S3 Object in the AWS Console." />
...
<Figure src="/images/image-17.png" caption="Amazon S3 bucket policy to enforce the s3:if-match header is always passed on PutObject requests." />
