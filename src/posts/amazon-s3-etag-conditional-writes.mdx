...
date: '2024-11-29'
feature_image: /content/images/2024/11/S3-Etags.png
tags:
  - AWS
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/UrGuKGxu9sY?feature=oembed" title="Amazon S3 ETags | .NET ON AWS | AWS Serverless | Amazon" />
...
<BookmarkCard href="/blog/amazon-s3-dotnet/" title="Amazon S3 For the .NET Developer: How to Easily Get Started" description="Learn how to get started with Amazon S3 from a .NET Core application. We will learn how to store and retrieve data from the storage, important concepts to be aware of while using S3." icon="/content/images/icon/logo-512x512-11.png" />
...
<BookmarkCard href="/blog/amazon-s3-conditional-requests-dotnet/" title="Exploring Amazon S3 Conditional Operations From .NET Application" description="Amazon S3 now supports conditional requests. You can use conditional requests to add preconditions to your S3 operations. If the precondition is not met it will result in the S3 operation failing. Let’s learn about Conditional Reads and Writes in Amazon S3 and how to use it from .NET" icon="/content/images/icon/logo-512x512-10.png" />
...
<ImageCard src="/content/images/2024/11/image-18.png" alt="ETag property on an Amazon S3 Object in the AWS Console." caption="ETag property on an Amazon S3 Object in the AWS Console." />
...
<ImageCard src="/content/images/2024/11/image-17.png" alt="Amazon S3 bucket policy to enforce the s3:if-match header is always passed on PutObject requests." caption="Amazon S3 bucket policy to enforce the s3:if-match header is always passed on PutObject requests." />
