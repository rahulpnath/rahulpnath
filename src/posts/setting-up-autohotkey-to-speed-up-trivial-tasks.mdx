...
excerpt: >-
  A lot of trivial tasks that we do daily on our computer can be automated to
  make it faster and reduce the number of keystrokes (as they are
  limited(http://www.keysleft.com)). AutoHoykey(https://autohotkey.com/)(AHK)...
tags:
  - Tools
  - Productivity
---
