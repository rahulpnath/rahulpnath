...
excerpt: >-
  We were facing a strange 'could not load DLL issue', when building and running multiple host projects in Visual Studio (VS 2015), side by side. We had 2 host projects...
tags:
  - Dotnet
  - Tools
---
...
![Double Write Dll conflict](/images/doubleWrite_msbuildLogViewer.png)
...
![Double Write Dll conflict](/images/doubleWrite_proj_msbuildLogViewer.png)
...
<Figure src="/images/doubleWrite_dll_conflict.jpg" caption="_Bin folder of Web application and Console application after building Shared project_" />
