...
feature_image: /images/MassTransit---RabbitMQ.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/0EXA9Vh7Iuw?feature=oembed" />
...
<iframe src="https://www.youtube.com/embed/videoseries?list=PL59L9XrzUa-ku74pfBcy4f3tigwfzGUrG" />
...
<BlogLink
  href="/blog/tag/rabbitmq/"
  title="RabbitMQ - Rahul Nath"
  ...
  featureImage="/images/RabbitMQ-2.png"
/>

You can host a RabbitMQ instance in multiple ways. For this blog post, I use an AWS MQ-hosted instance of RabbitMQ.

<Figure src="/images/image-27.png" caption="Creating an AWS MQ hosted instance of RabbitMQ." />
...
<Figure src="/images/MassTransit-RabbitMQ-Queue-Topology.png" caption="Defauilt MassTransit Queue Topology for RabbitMQ." />
...
<Figure src="/images/image-7.png" caption="RabbitMQ Queues set up by MassTransit for each consumer." />
