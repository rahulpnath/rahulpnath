...
<Figure src="/images/image.png" caption="You have successfully created both a User Pool and also an App Client." />
...
<Figure src="/images/image-9.png" caption="You will get back the idToken, accessToken and also a refreshToken." />
