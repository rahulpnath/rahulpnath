...
date: '2020-05-15'
feature_image: /content/images/how_to_create_zip_file_in_asp_net.jpg
tags:
  - Programming
excerpt: >-
  Learn how to generate a ZIP file containing many CSV files in an ASP.Net Web
  API application. The same approach is useful to zip files of any type in any
  .NET application using CSharp.
---
...
<ImageCard src="/content/images/how_to_create_zip_file_in_asp_net.jpg" alt="How to create a zip file in ASP.NET" />
