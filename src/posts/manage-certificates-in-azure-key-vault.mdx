...
excerpt: >-
  ...
  In one of my earlier posts, PFX Certificate in Azure Key
  Vault(GHOSTURL/blog/pfx-certificate-in-azure-key-vault/), we saw how to save
  PFX Certificate files in Key Vault as Secrets. Azure Key Vault...
tags:
  - Azure
---
