...
feature_image: /images/Lambda-Function-JetBrains-Rider---Deploy.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/gKrqXshsZZQ?feature=oembed" />
...
<Figure src="/images/image-23.png" caption="Create new AWS Lambda Function using the AWS Toolkit in JetBrains Rider." />
...
<Figure src="/images/image-28.png" caption="Create and deploy new Lambda Function for JetBrains Rider IDE" />
...
<Figure src="/images/image-22.png" caption="Show gutter icons for all potential AWS Lambda handlers in the JetBrains Rider IDE." />
...
<Figure src="/images/image-24.png" caption="JetBrains Rider Gutter option to interact with Lambda Function handler." />
...
Update existing Lambda Function from JetBrains Rider, by right click on an existing Lambda Function. You can update the configuration or upload new code changes using this option.
...
<Figure src="/images/image-26.png" caption="Update Lambda function code for an existing function using JetBrains Rider IDE." />
