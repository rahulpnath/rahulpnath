...
<Figure src="/images/api-gateway-rest-api-create-method.jpg" caption="To complete the creation of a Method, you must choose and set up an Integration point." />
...
<Figure src="/images/api-gateway-rest-api-configure-method-response.jpg" caption="### Setting up Integration Request/Response" />
