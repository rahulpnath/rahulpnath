...
<EmbedCard src="https://www.youtube.com/embed/mOaV5LwfzUE" />
...
<ImageCard src="/content/images/api-gateway-rest-api-create.jpg" alt="Create an Amazon API Gateway REST API by providing a name, description, and endpoint type. " />
...
<ImageCard src="/content/images/api-gateway-rest-api-create-resource.jpg" alt="Add a Resource to the API. Resources have a name and are uniquely identified by a path." />
...
<ImageCard src="/content/images/api-gateway-rest-api-create-method.jpg" alt="Create a method under the resource by selecting the appropriate HTTP Verb to invoke the method." />
...
<ImageCard src="/content/images/api-gateway-rest-api-create-integration.jpg" alt="" />
...
<ImageCard src="/content/images/api-gateway-rest-api-configure-method-request.jpg" alt="Configure the headers, query string parameters, authorization, validators etc. on the incoming HTTP method request." />
...
<ImageCard src="/content/images/api-gateway-rest-api-configure-method-response.jpg" alt="Configure Method Response for REST API in Amazon API Gateway" />
...
<ImageCard src="/content/images/api-gateway-rest-api-configure-integration-request.jpg" alt="Integration Request using VTL mapping template for a mock integration in Amazon API Gateway REST API." />
...
<ImageCard src="/content/images/api-gateway-rest-api-configure-integration-response.jpg" alt="Configure Integration Response for REST API in Amazon API Gateway" />
...
<ImageCard src="/content/images/api-gateway-rest-api-create-stage.jpg" alt="Create a new stage to deploy an Amazon API Gateway REST API." />
...
<ImageCard src="/content/images/api-gateway-rest-api-deploy-stages.jpg" alt="Deploy REST API to multiple stages and manage configurations." />
