...
date: '2017-08-08'
feature_image: /content/images/pdf_generation_flow.png
tags:
  - Programming
...
```
<ImageCard src="/content/images/pdf_generation.png" alt="Select options to download" />
...
<ImageCard src="/content/images/pdf_generation_flow.png" alt="PDF Generation Flow" />
