...
date: '2015-12-25'
feature_image: /content/images/tsc_options.png
tags:
  - Programming
excerpt: >-
  A short post on setting up the environment for starting with TypeScript, so as
  to see generated JavaScript real-time.
---
...
```
<ImageCard src="/content/images/tsc_options.png" alt="Visual Studio Code Coverage" />
...
<ImageCard src="/content/images/TypeScript.gif" alt="Visual Studio Code Coverage" />
