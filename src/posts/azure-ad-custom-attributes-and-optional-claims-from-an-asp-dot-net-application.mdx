...
feature_image: "/images/AzureAd_schema_extension_optionalClaims.png"
tags: ["Azure","Dotnet"]
---
...
![Azure AD Graph API Permissions](/images/azureAd_GraphApi_Permissions.png)
...
![Azure AD Application Manifest - Optional Claims](/images/AzureAd_schema_extension_optionalClaims.png)
...
I updated the idToken property as the .Net Core Web Application was using JWT ID token. If you are unsure of what token you can use [Fiddler](/posts/fiddler-free-web-debugging-proxy/) to find what kind of token is used (as shown below).

![Id token returned](/images/AzureAd_idToken.png)
