...
<Figure src="/images/image-1.png" caption="Producer sending a message to Queue and consumer pulling messages from Queue." />
...
<Figure src="/images/image-6.png" caption="Exchange information in RabbitMQ Management Console (hosted in Amazon MQ)" />
...
<BlogLink
  ...
  title="Direct Exchange - RabbitMQ"
