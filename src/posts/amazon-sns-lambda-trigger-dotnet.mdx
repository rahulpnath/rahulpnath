...
<Figure src="/images/aws-sns-lambda-trigger-sns-subscriptions.jpg" caption="### Testing SNS Lambda Trigger Integration" />
...
<Figure src="/images/aws-sns-lambda-trigger-cloudwatch-log.jpg" caption="## Scaling and Lambda Concurrency" />
...
<Figure src="/images/aws-sns-lambda-trigger-concurrent-executions.jpg" caption="### Lambda Concurrency Configuration" />
...
<Figure src="/images/aws-sns-lambda-trigger-concurrent-executions-update.jpg" caption="### Asynchronous Invocation" />
...
<Figure src="/images/aws-sns-lambda-trigger-asynchronous-configuration.jpg" caption="### Handle Stale Subscription Errors" />
...
<Figure src="/images/aws-sns-lambda-trigger-subscription-configuration.jpg" caption="Amazon SNS doesn’t retry the message delivery due to client-side errors." />
