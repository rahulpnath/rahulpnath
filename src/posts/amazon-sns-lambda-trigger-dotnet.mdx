...
date: '2022-09-26'
feature_image: /content/images/amazon-sns-lambda-triggers-dotnet.jpg
tags:
  - AWS
  - Lambda
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/vIR1Mqa8Lo8" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-create.jpg" alt="Select SNS as the source and specify the SNS Topic name or ARN to set up the Lambda trigger." />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-sns-subscriptions.jpg" alt="SNS Subscriptions showing the Lambda Function trigger." />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-publish-message.jpg" alt="Test send a message to Amazon SNS from the console." />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-cloudwatch-log.jpg" alt="aws-sns-lambda-trigger-cloudwatch-log" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-message-spike.jpg" alt="" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-concurrent-executions.jpg" alt="" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-concurrency-configuration.jpg" alt="" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-concurrency-configuration-edit.jpg" alt="" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-concurrent-executions-update.jpg" alt="" />
...
<ImageCard src="/content/images/aws-lambda-function-asynchronous-processing.jpg" alt="SNS Triggers Lambda Function asynchronously. Messages are delivered to a queue on the Lambda side and it’s the Lambda’s responsibility to process the messages." />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-asynchronous-configuration.jpg" alt="" />
...
<ImageCard src="/content/images/aws-sns-lambda-trigger-subscription-configuration.jpg" alt="" />
