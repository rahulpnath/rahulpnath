...
date: 2025-01-17
feature_image: /images/OpenSearch-.NET.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/HpCvLEBouI8?feature=oembed" />
...
<BlogLink
  href="/blog/dynamodb-etl-opensearch-amazon/"
  title="DynamoDB Zero-ETL Integration With Amazon OpenSearch Service"
  description="Let’s learn how to set up the DynamoDB Zero ETL plugin for OpenSearch, a fully managed, no-code setup for ingesting data into Amazon OpenSearch Service."
  authorImage="/images/logo-512x512-15.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/DynamoDB-Zero-ETL.png"
/>
...
<Figure src="/images/image-1.png" caption="DynamoDB Movie table sample record." />
...
<BlogLink
  ...
  authorImage="/images/logo-512x512-16.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/secure-key-1.jpg"
/>
