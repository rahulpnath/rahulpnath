...
date: 2025-02-03
feature_image: /images/Lambda-SnapStart.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/VGyxP4Sff2I?feature=oembed" />
...
<Figure src="/images/image-2.png" caption="Invoking Lambda Function from the AWS Console, under the Test tab." />
...
<BlogLink
  ...
  authorImage="/images/logo-512x512-17.png"
...
<Figure src="/images/image-4.png" caption="CloudWatch LogStreams showing multiple log streams, one per instance of Lambda Function created." />
...
<Figure src="/images/image-5.png" caption="Enable Lambda SnapStart under the General Configuration of the Lambda Function." />

Once enabled, you can see this in the General configuration as shown below.

<Figure src="/images/image-6.png" caption="Lambda Function with SnapStart enabled by setting it to PublishedVersions." />
...
<Figure src="/images/image-10.png" caption="AWS CloudWatch logs for initialization of AWS Lambda SnapStart enabled version." />
...
[<Figure src="/images/image-11.png)](https://aws.amazon.com/blogs/compute/starting-up-faster-with-aws-lambda-snapstart/" caption="AWS Lambda Lifecycle compared between SnapStart and non-SnapStart Lambda Functions." />
...
<Figure src="/images/image-15.png" caption="Logs showing unique data generated in the constructor code for a non-SnapStart Lambda Function" />
...
<Figure src="/images/image-14.png" caption="Logs showing unique data generated in the constructor code for a SnapStart enabled Lambda Function" />
...
<Figure src="/images/image-17.png" caption="Logs showing data generated in the Runtime hooks for a SnapStart enabled Lambda Function" />
...
_You are charged for caching a snapshot over the period that your function version is active, for a minimum of 3 hours and per millisecond thereafter. The price depends on the amount of memory you allocate to your function._
