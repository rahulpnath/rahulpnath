...
![](/images/logo-512x512-17.png)Rahul NathRahul Pulikkot Nath
...
With SnapStart enabled Lambda Functions, the Lifecycle differs from a [normal Lambda Function](/posts/lambda-lifecycle-and-net/).

You can find the comparison in the Lifecycle in the diagram below.

[![](/images/image-11.png)](https://aws.amazon.com/blogs/compute/starting-up-faster-with-aws-lambda-snapstart/)
