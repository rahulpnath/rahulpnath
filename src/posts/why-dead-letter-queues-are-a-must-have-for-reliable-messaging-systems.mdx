...
<BookmarkCard href="/blog/aws-message-processing-framework/" title="A Step-by-Step Guide to AWS Message Processing with Amazon SQS in .NET" description="The AWS Message Processing Framework for .NET is an AWS-native toolkit for building .NET applications with messaging services like SQS and EventBridge. Let’s learn how to start using it when creating .NET applications on AWS." icon="/content/images/icon/logo-512x512-14.png" />
