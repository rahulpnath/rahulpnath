...
feature_image: /images/Dead-Letter-Queue.png
excerpt: >-
  ...
  post, we will explore what a Dead Letter Queue is, why it’s important, and the
...
<iframe src="https://www.youtube.com/embed/0gmNQdkHkzg?feature=oembed" />
...
<BlogLink
  href="/blog/aws-message-processing-framework/"
  title="A Step-by-Step Guide to AWS Message Processing with Amazon SQS in .NET"
  description="The AWS Message Processing Framework for .NET is an AWS-native toolkit for building .NET applications with messaging services like SQS and EventBridge. Let’s learn how to start using it when creating .NET applications on AWS."
  authorImage="/images/logo-512x512-14.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/AWS-Message-Processing-Fwk--1-.png"
/>
...
__A Transient error, also known as a transient fault or soft error, is a temporary error in a system or network that resolves itself quickly.__
...
<Figure src="/images/image-2.png" caption="Setting up a Dead Letter Queue on Amazon SQS" />
