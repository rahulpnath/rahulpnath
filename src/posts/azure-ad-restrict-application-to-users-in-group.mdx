...
excerpt: >-
  For one of the web application I was working on, access was to be restricted based on user belonging to a particular Azure AD Group. The application as such did...
tags:
  - Azure
---
...
<Figure src="/images/azure_ad_user_role_error.jpg" caption="## Adding User to Role" />
