...
<Figure src="/images/image-4.png" caption="Creating an AWS EC2 instance from the AWS Console - specify name and OS image." />
...
<Figure src="/images/image-5.png" caption="EC2 instance type allows to choose CPU, memory, networking resources for your instance." />
...
<Figure src="/images/image-7.png" caption="Create and assign a key pair to connect to your EC2 instances." />
...
<Figure src="/images/image-8.png" caption="## Connecting to EC2 and Setting Up .NET Runtime" />
...
<Figure src="/images/image-14.png" caption="Connecting to EC2 instance using ssh from your terminal" />
