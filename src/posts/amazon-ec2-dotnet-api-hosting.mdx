...
date: '2024-07-24'
feature_image: /content/images/2024/07/EC2-ASP-NET.png
tags:
  - AWS
  - EC2
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/tfjAE6hiN5c?feature=oembed" title="Hosting ASP NET on EC2 | .NET ON AWS | AWS ECS | Amazon" />
...
<ImageCard src="/content/images/2024/07/image-4.png" alt="Creating an AWS EC2 instance from the AWS Console - specify name and OS image." caption="Creating an AWS EC2 instance from the AWS Console - specify name and OS image." />
...
<ImageCard src="/content/images/2024/07/image-5.png" alt="EC2 instance type allows to choose CPU, memory, networking resources for your instance." caption="EC2 instance type allows to choose CPU, memory, networking resources for your instance." />
...
<ImageCard src="/content/images/2024/07/image-6.png" alt="Configure the network settings for your EC2 instance to control who/where your instances can be accessed." caption="Configure the network settings for your EC2 instance to control who/where your instances can be accessed." />

If you want to connect to the EC2 instance remotely, you can create a key pair and assign it to the EC2 instance.

<ImageCard src="/content/images/2024/07/image-7.png" alt="Create and assign a key pair to connect to your EC2 instances." caption="Create and assign a key pair to connect to your EC2 instances." />
...
<ImageCard src="/content/images/2024/07/image-8.png" alt="" />
...
<ImageCard src="/content/images/2024/07/image-10.png" alt="" />
...
<ImageCard src="/content/images/2024/07/image-11.png" alt="" />

Once the permissions are updated, you can connect to the EC2 machine successfully using ssh.

<ImageCard src="/content/images/2024/07/image-14.png" alt="Connecting to EC2 instance using ssh from your terminal" caption="Connecting to EC2 instance using ssh from your terminal" />
...
<ImageCard src="/content/images/2024/07/image-12.png" alt="Add inbound rules to open the required ports for your application so that it can be accessed using the public URL of the EC2 machine." caption="Add inbound rules to open the required ports for your application so that it can be accessed using the public URL of the EC2 machine." />
