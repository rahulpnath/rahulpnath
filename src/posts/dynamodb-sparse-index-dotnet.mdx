...
<BlogLink
  ...
  authorName="Rahul Pulikkot Nath"
  authorTitle="Rahul Nath"
...
<Figure src="/images/image.png" caption="You can create a Local Secondary Index only at the time of DynamoDB table creation." />
...
<Figure src="/images/image-1.png" caption="## Populating DynamoDB Sparse Index From .NET" />
