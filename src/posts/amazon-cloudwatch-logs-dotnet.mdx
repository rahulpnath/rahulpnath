...
date: '2022-05-03'
feature_image: /content/images/logs.jpg
tags:
  - AWS
excerpt: >-
  Learn how to use Amazon CloudWatch when building .NET applications. We will
  learn how to write logs into CloudWatch, filter the logs, some good practices
  when logging, learn about Log Analytics, and see how we can filter and view
  logs across multiple applications.
---
...
<EmbedCard src="https://www.youtube.com/embed/-46yTm4DoEI" />
...
The [main concepts](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogsConcepts.html) that you’ll keep coming across when using CloudWatch Logs are _Log events_, _Log streams, and Log groups._
...
> _I prefer using Serilog for easy integration and out-of-the-box structured logging support._
...
<ImageCard src="/content/images/aws-cloudwatch-logs-text-filter.jpg" alt="Text based filtering in CloudWatch log group, Showing all logs which do not have Brisbane and have number 9" />
...
> _Don’t use string interpolation while writing log messages. Pass the values as parameters to the log methods._
...
<ImageCard src="/content/images/aws-cloudwatch-log-comparison.jpg" alt="Text based Logs vs structured logging" />
...
_eg. {$.count > 10 && $.cityName = “Brisbane”}_ → selects all log events that have a count property greater than 10 with the cityName property as Brisbane.

<ImageCard src="/content/images/aws-cloudwatch-log-structured-filter.jpg" alt="JSON based log filtering example with multiple properties" />
...
> _There can be a delay between events showing up in Log Groups and their appearing in CloudWatch Log Insights._
...
<ImageCard src="/content/images/aws-cloudwatch-logs-insights.jpg" alt="Sample query in aws cloudwatch log insights" />
...
<ImageCard src="/content/images/aws-cloudwatch-logs-insights-multiple-log-groups.jpg" alt="Query across multiple log groups in CloudWatch log insigths" />
...
<ImageCard src="/content/images/aws-cloudwatch-logs-insights-saved-queries.jpg" alt="Saved queries in CloudWatch Log Insights" />
