...
date: 2010-12-20
excerpt: >-
  It's not been that long that I've been into the IT servicing industry.But still the learning curve I've had during the  past few years has been dramatic.The first time I...
tags:
  - Dotnet
---
...
1.  Should have known/read of \[SOLID\](http://en.wikipedia.org/wiki/Solid\_(object-oriented\_design)) ,\[GRASP\](http://en.wikipedia.org/wiki/GRASP\_(object-oriented\_design)) principles.

1.  Awareness of certain \[design patterns\](http://en.wikipedia.org/wiki/Design\_pattern\_(computer\_science)) would have helped to create a better design.
