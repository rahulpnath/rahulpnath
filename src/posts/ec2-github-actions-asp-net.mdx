...
date: '2025-07-13'
feature_image: /content/images/2025/07/Copy-of-AWS-EC2-Build-Deploy-Pipeline--1-.png
tags:
  - AWS
  - EC2
excerpt: >-
  Let's learn how to set up a GitHub Actions build-deploy pipeline to deploy an
  ASP.NET API application to an Amazon EC2 instance, running as a systemd
  service.
---
...
<EmbedCard src="https://www.youtube.com/embed/hViTuEA75-w?feature=oembed" title="Deploying ASP.NET API on Amazon EC2 Using GitHub Actions" />

This post is part of my [AWS EC2 series](/blog/tag/ec2/), and thanks to AWS for sponsoring this video.

If you are completely new to running .NET apps on AWS EC2 I highly recommend checking out my Step-by-Step guide.

<BookmarkCard href="/blog/amazon-ec2-dotnet-api-hosting/" title="Deploying a .NET Web API on Amazon EC2: A Step-by-Step Guide" description="Let’s learn how to leverage Amazon EC2 to host your .NET applications. In this post, we will learn how to create an EC2 instance, set it up with .NET runtime, upload your .NET application, and run it from there." icon="/content/images/icon/logo-512x512-22.png" />
...
<ImageCard src="/content/images/2025/06/image.png" alt="" />
...
__A systemd service lets you manage your application like any other Linux service — you can start, stop, restart, and enable it to run automatically on boot.__
