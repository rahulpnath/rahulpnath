...
slug: aws-cdk-dotnet
date: '2024-11-20'
feature_image: /content/images/2024/11/AWS-CDK.png
tags:
  - AWS
excerpt: >-
  AWS CDK simplifies Cloud Infrastructure management. CDK lets you define AWS
  resources using first-class programming concepts. 

  It translates your code into AWS CloudFormation templates, which can be used
  to provision AWS resources for your application. Let's get started using .NET
  and C#.
---
...
<EmbedCard src="https://www.youtube.com/embed/D6HAbrP5wyQ?feature=oembed" title="AWS CDK For .NET Developer | Getting Started | AWS CDK SERIES" />
...
<BookmarkCard href="/blog/amazon-credentials-dotnet/" title="Learn How To Manage Credentials When Building .NET Application on AWS" description="Learn different ways to set up and manage credentials and sensitive information when building .NET applications on AWS. We will also touch upon some of the tools and utilities that I have set up on my local development machine to make working with AWS easier." icon="/content/images/icon/logo-512x512-5.png" />
...
__The CDK CLI uses this directory name to name things within your CDK code.__
...
<ImageCard src="/content/images/2024/11/image-2.png" alt="CDK project structure for .NET showing the cdk.json file in Visual Studio Code." caption="CDK project structure for .NET showing the cdk.json file in Visual Studio Code." />
...
<BookmarkCard href="/blog/aws-lambda-dotnet-developer/" title="AWS Lambda For The .NET Developer" description="This blog post is a collection of other posts that covers various aspects of AWS Lambda and other services you can integrate with when building serverless applications on Lambda." icon="/content/images/icon/logo-512x512-6.png" />
...
<ImageCard src="/content/images/2024/11/image-3.png" alt="Running cdk deploy from commandline to deploy AWS CDK to my AWS Account using Windows terminal." caption="Running cdk deploy from commandline to deploy AWS CDK to my AWS Account using Windows terminal." />
...
<ImageCard src="/content/images/2024/11/image-4.png" alt="AWS CloudFormation Stack crated using CDK deploy from .NET." caption="AWS CloudFormation Stack crated using CDK deploy from .NET." />
...
_.... Make sure it's not a production app (I should have said that earlier)_
