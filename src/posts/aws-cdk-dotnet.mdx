...
slug: "aws-cdk-dotnet"
date: "2024-11-20T06:59:50.000Z"
feature_image: "/images/AWS-CDK.png"
tags: ["AWS"]
excerpt: "A practical guide for .NET developers to get started with AWS CDK. Learn core concepts, setup, project creation, and how to define and deploy cloud infrastructure using familiar programming languages."
---
...
<iframe src="https://www.youtube.com/embed/D6HAbrP5wyQ?feature=oembed" />
...
![](/images/logo-512x512-5.png)Rahul NathRahul Pulikkot Nath
...
CDK project structure for .NET showing the cdk.json file in Visual Studio Code.
...
![](/images/logo-512x512-6.png)Rahul NathRahul Pulikkot Nath
...
Running cdk deploy from commandline to deploy AWS CDK to my AWS Account using Windows terminal.
...
AWS CloudFormation Stack crated using CDK deploy from .NET.
