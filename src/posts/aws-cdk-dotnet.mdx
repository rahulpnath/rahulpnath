...
<BlogLink
  ...
  authorImage="/images/logo-512x512-5.png"
...
<Figure src="/images/image-2.png" caption="CDK project structure for .NET showing the cdk.json file in Visual Studio Code." />
...
<BlogLink
  ...
  authorImage="/images/logo-512x512-6.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
...
<Figure src="/images/image-3.png" caption="Running cdk deploy from commandline to deploy AWS CDK to my AWS Account using Windows terminal." />
...
<Figure src="/images/image-4.png" caption="AWS CloudFormation Stack crated using CDK deploy from .NET." />
