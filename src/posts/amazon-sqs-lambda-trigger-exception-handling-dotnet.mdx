...
<Figure src="/images/aws-lambda-trigger-sqs-dead-letter-queue-setup.jpg" caption="### Maximum Receives Count" />
...
<Figure src="/images/aws-lambda-trigger-sqs-dead-letter-queue-messages-detail.jpg" caption="## ReDrive Messages from Dead-letter Queue" />
