...
date: '2022-09-22'
feature_image: /content/images/amazon-sqs-lambda-trigger-exception-handling-dotnet.jpg
tags:
  - AWS
  - Lambda
excerpt: >-
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-exception-simulation.jpg" alt="Send a message to SQS with the body 'Test Exception' to simulate an exception in processing in the .NET Lambda Function." />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-dead-letter-queue.jpg" alt="" />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-dead-letter-queue-setup.jpg" alt="" />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-dead-letter-queue-messages.jpg" alt="View messages in the Dead-letter Queue as they arrive. You can Poll for messages from the console and view the message details." />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-dead-letter-queue-messages-detail.jpg" alt="View message details in SQS Console" />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-dead-letter-queue-redrive.jpg" alt="The Redrive option allows you to pick and choose the messages to reprocess. You can send the messages back to the source queue or a custom destination." />
...
<ImageCard src="/content/images/aws-lambda-trigger-sqs-batch-item-failures.jpg" alt="" />
