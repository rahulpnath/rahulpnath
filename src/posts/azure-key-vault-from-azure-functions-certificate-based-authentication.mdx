...
feature_image: "/images/azureFunction_newFunctionApp.png"
tags: []
---
...
![Azure Function New App](/images/azureFunction_newFunctionApp.png)
...
![Azure Function Platform Features](/images/azureFunction_PlatformFeatures.png)

Upload the certificate by selecting it from your folder system.

![Azure Function Upload Certificate](/images/azureFunction_addCertificate.png)
...
![Azure Function Certificates App Settings](/images/azureFunction_AppSetting.png)
...
Make sure you add in the _project.json_ as seen in the [previous post](__GHOST_URL__/blog/azure-key-vault-from-azure-functions/) to enable the required NuGet packages. The Azure function now uses the certificate to authenticate with Key Vault and retrieve the secret.
