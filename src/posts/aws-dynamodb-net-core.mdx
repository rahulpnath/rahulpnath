...
<Figure src="/images/aws_dynamodb_create_table_portal.jpg" caption="To add items to the Table from the portal, use the _Create Item_ button." />
...
<Figure src="/images/aws_dynamodb_create_item_portal.jpg" caption="There can be any other property on the Item and necessarily need not be the same for each item." />
...
<Figure src="/images/aws_dynamodb_table_items_portal.jpg" caption="## Set up App to Use DynamoDB" />
...
<Figure src="/images/aws_dynamodb_iam_user.jpg" caption="Run the application, and voila! We have the API now retrieving the data from DynamoDB." />
