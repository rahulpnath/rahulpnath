...
date: '2021-04-06'
feature_image: /content/images/aws_dynamodb.jpg
tags:
  - AWS
  - DynamoDB
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/BbUmLRaxZG8" />
...
<ImageCard src="/content/images/aws_dynamodb_create_table_portal.jpg" alt="Create table in AWS DynamoDB from the Console" />
...
<ImageCard src="/content/images/aws_dynamodb_create_item_portal.jpg" alt="Create Item in DynamoDB table" />
...
<ImageCard src="/content/images/aws_dynamodb_table_items_portal.jpg" alt="DynamoDB Table with Items" />
...
<ImageCard src="/content/images/aws_dynamodb_iam_user.jpg" alt="Add User in IAM to access DynamoDB" />
...
<ImageCard src="/content/images/aws_dynamodb_sdk_overview.jpg" alt="AWS Dynamodb .NET SDK Overview" />
