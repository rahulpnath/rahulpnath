...
When creating the API Gateway, a _$default_ stage is automatically created. This stage is served from the base of the APIs URL. For a new stage, it will have the base URL followed by the stage name - `https://{api\_id}.execute-api.{region}.amazonaws.com/{stageName}`
