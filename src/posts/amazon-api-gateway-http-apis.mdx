...
<Figure src="/images/api-gateway-http-api-create-route.jpg" caption="**Create and Attach Integration**" />
...
<Figure src="/images/api-gateway-http-api-create-stage.jpg" caption="Create a new Stage in API Gateway api-gateway-http-api-create-stage.jpg" />
