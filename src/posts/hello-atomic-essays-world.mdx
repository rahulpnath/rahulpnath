...
excerpt: >-
  !Keychron K2 keyboard, Photo by Sumeesh Nagisetty on Unsplash(/images/keychronk2.jpg)  I am a programmer, so let's start with a Hello World for Atomic Essays!  First things first, What is...
tags:
  - Essays
---
<Figure src="/images/keychron_k2.jpg" caption="I am a programmer, so let's start with a Hello World for Atomic Essays!" />
