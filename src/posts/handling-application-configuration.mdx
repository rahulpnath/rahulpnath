---
title: "5 Ways to Handle Application Configuration & Secrets With Azure \U0001F510"
slug: handling-application-configuration
date: '2021-10-25'
feature_image: /content/images/secret.jpg
tags:
  - Azure
  - Dotnet
excerpt: >-
  Handing application configuration can be tricky. Let's dive into 5 different
  ways we can manage application secrets, configuration, connection strings, etc
  when building an ASP NET Application on Azure.
---
...
<EmbedCard src="https://www.youtube.com/embed/wTSu2aCoR7Y" />
...
<EmbedCard src="https://www.youtube.com/embed/UPgHRiLw4is" />
...
<EmbedCard src="https://www.youtube.com/embed/PkLLP2tcd28" />
...
<ImageCard src="/content/images/configuration_app_settings.jpg" alt="App Settings From Different Configuration Sources" />
...
<EmbedCard src="https://www.youtube.com/embed/videoseries?list=PL59L9XrzUa-m7AFDgjWuwm6exyCklc03U" />
...
<ImageCard src="/content/images/configuration_azure_devops_variables.jpg" alt="Configuration value set in Azure DevOps Release Variables" />
...
<ImageCard src="/content/images/configuration_azure_devops_app_settings_transform.jpg" alt="Azure DevOps Web Application Transform for configuration" />
...
<ImageCard src="/content/images/configuration_azure_app_settings.jpg" alt="Configuration From Azure App Settings in Web App Configuration" />
...
<BookmarkCard href="/blog/connect-net-core-to-azure-key-vault-in-ten-minutes" title="Connect .Net Core To Azure Key Vault In Ten Minutes" description="Access secrets in Azure Key Vault from .Net Core and learn how to elegantly handle when rotating secrets." icon="/favicon.ico" />
...
<EmbedCard src="https://www.youtube.com/embed/VEjYW14WKRM" />
...
<BookmarkCard href="/blog/defaultazurecredential-from-azure-sdk" title="DefaultAzureCredential: Unifying How We Get Azure AD Token" description="Azure Identity library provides Azure Active Directory token authentication support across the Azure SDK" icon="/favicon.ico" />
