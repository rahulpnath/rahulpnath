...
date: '2023-11-01'
feature_image: /content/images/2023/10/Lambda-Function-JetBrains-Rider.png
tags:
  - AWS
  - Lambda
excerpt: >-
...
<EmbedCard src="https://www.youtube.com/embed/jwRs45mA568?feature=oembed" title="AWS TOOLKIT on JetBrains Rider IDE | .NET ON AWS | Serverless | Amazon" />
...
<ImageCard src="/content/images/2023/10/image-17.png" alt="Installing the AWS Toolkit Plugin from the Settings menu in JetBrains Rider IDE." caption="Installing the AWS Toolkit Plugin from the Settings menu in JetBrains Rider IDE." />

Once installed you can see an additional icon, with the AWS logo (as shown in the screenshot below) on the left sidebar.

<ImageCard src="/content/images/2023/10/image-20.png" alt="AWS Toolkit in JetBrains Rider" caption="AWS Toolkit in JetBrains Rider" />
...
<ImageCard src="/content/images/2023/10/image-18.png" alt="" />
...
<ImageCard src="/content/images/2023/10/image-21.png" alt="JetBrains Rider Lambda Simple SQS Function template to integrate Amazon SQS with AWS Lambda" caption="JetBrains Rider Lambda Simple SQS Function template to integrate Amazon SQS with AWS Lambda" />
...
<BookmarkCard href="/blog/aws-lambda-dotnet-developer/" title="AWS Lambda For The .NET Developer" description="This blog post is a collection of other posts that covers various aspects of AWS Lambda and other services you can integrate with when building serverless applications on Lambda." icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
...
<BookmarkCard href="/blog/how-to-set-up-aws-net-mock-lambda-test-tool-on-jetbrains-rider/" title="How To Set Up AWS .NET Mock Lambda Test Tool on JetBrains Rider" description="Learn how to setup .NET Mock Lambda Test Tool to work with JetBrains Rider IDE." icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
