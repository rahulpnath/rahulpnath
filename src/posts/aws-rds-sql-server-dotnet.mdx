...
<Figure src="/images/image.png" caption="Create a database from AWS Console under the RDS" />
...
<Figure src="/images/image-4.png" caption="AWS RDS SQL Server Settings and master credentials." />
...
<Figure src="/images/image-5.png" caption="You can choose the instance size and the amount of storage required based on your application needs." />
...
<Figure src="/images/image-6.png" caption="⚠️" />
...
<Figure src="/images/image-7.png" caption="Public access to RDS SQL Server instance assigns a public IP address to the database." />

This covers the main settings you must know when creating an RDS SQL Server instance.

Create the database!

<Figure src="/images/image-8.png" caption="RDS SQL Server database" />
...
<Figure src="/images/image-10-1.png" caption="RDS SQL Server Instance details in AWS Console." />

Below, I am using Azure Data Studio to connect to it, and here's how adding a new connection looks.

<Figure src="/images/image-9.png" caption="Azure Data Studio connect to RDS SQL Server" />
