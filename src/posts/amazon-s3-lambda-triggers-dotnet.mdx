...
<Figure src="/images/s3-trigger-lambda-invoke-permission.jpg" caption="### IAM Policies" />
...
<Figure src="/images/s3-lambda-iam-permissions.jpg" caption="### Testing Integration" />
