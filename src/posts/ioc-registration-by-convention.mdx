...
feature_image: /images/ioc_usefulness.png
excerpt: >-
  Sometime back we had seen, how to configure the unity container using
  code/config
  file(GHOSTURL/blog/configuring-unity-container-comparing-code-and-xml-configuration-side-by-side/)
  and I was using a mix of this in one of my projects. This approach soon...
tags:
  - Dotnet
---
...
[<Figure src="/images/ioc_usefulness.png)](http://bit.ly/1zLiq6p" caption="## Convention Over Configuration" />
