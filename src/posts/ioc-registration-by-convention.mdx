...
date: "2015-01-03T18:03:17.000Z"
feature_image: "/images/ioc_usefulness.png"
tags: ["Dotnet"]
---

Sometime back we had seen, how to [configure the unity container using code/config file](/posts/configuring-unity-container-comparing-code-and-xml-configuration-side-by-side/) and I was using a mix of this in one of my projects. This approach soon became an overhead, as the manual wiring up of registrations is really cumbersome and also error prone. Mostly there were missing registrations only to be found out, when doing test runs or deployments. We soon were forced to move out of the manual registration and find a new way to register dependencies.
