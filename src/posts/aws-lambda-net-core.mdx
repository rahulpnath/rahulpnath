...
<Figure src="/images/aws_toolkit_visual_studio.jpg" caption="## Setting Up First Project" />
...
<Figure src="/images/aws_mock_lambda_tool.jpg" caption="### Lambda Triggers" />
...
<Figure src="/images/aws_publish_to_aws_lambda_1.jpg" caption="Click the Upload button to upload and publish the Lambda Function to the selected AWS environment." />
