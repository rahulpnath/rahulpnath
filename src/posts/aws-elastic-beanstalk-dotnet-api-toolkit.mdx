...
This post is sponsored by AWS and is part of my [.NET on AWS Series](/posts/tag/aws/)
...
Yes AWS Elastic Beanstalk uses [EC2 instances](/posts/amazon-ec2-dotnet-api-hosting/) to deploy the applications.
