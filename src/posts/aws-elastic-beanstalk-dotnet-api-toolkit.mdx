...
date: '2024-08-15'
feature_image: /content/images/2024/08/Beanstalk---AWS-Toolkit--1-.png
tags:
  - AWS
  - Dotnet
excerpt: >-
...
<ImageCard src="/content/images/2024/08/image-15.png" alt="Publish to AWS from Visual Studio using AWS Toolkit .NET" caption="Publish to AWS from Visual Studio using AWS Toolkit .NET" />
...
<ImageCard src="/content/images/2024/08/image-17.png" alt="Visual Studio AWS Toolkit options to deploy .NET applications to Elastic Beanstalk." caption="Visual Studio AWS Toolkit options to deploy .NET applications to Elastic Beanstalk." />
...
<ImageCard src="/content/images/2024/08/image-18.png" alt="Visual Studio AWS Toolkit configuration options to deploy ASP NET API application to Elastic Beanstalk." caption="Visual Studio AWS Toolkit configuration options to deploy ASP NET API application to Elastic Beanstalk." />
...
<ImageCard src="/content/images/2024/08/image-19.png" alt="Visual Studio AWS Toolkit configuration hosting options to deploy ASP NET API application to Elastic Beanstalk." caption="Visual Studio AWS Toolkit configuration hosting options to deploy ASP NET API application to Elastic Beanstalk." />
...
<ImageCard src="/content/images/2024/08/image-20.png" alt="Visual Studio AWS Toolkit deploy ASP NET application to AWS Elastic Beanstalk" caption="Visual Studio AWS Toolkit deploy ASP NET application to AWS Elastic Beanstalk" />
...
<ImageCard src="/content/images/2024/08/image-21.png" alt="" />
...
<ImageCard src="/content/images/2024/08/image-22.png" alt="" />
...
<ImageCard src="/content/images/2024/08/image-23.png" alt="" />
...
<ImageCard src="/content/images/2024/08/image-24.png" alt="" />
...
<ImageCard src="/content/images/2024/08/image-25.png" alt="" />
...
<ImageCard src="/content/images/2024/08/image-26.png" alt="Visual Studio AWS Elastic Beanstalk publish a new environment to an existing Beanstalk spplication." caption="Visual Studio AWS Elastic Beanstalk publish a new environment to an existing Beanstalk spplication." />
