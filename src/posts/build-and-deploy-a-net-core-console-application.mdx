...
date: '2018-01-03'
feature_image: /content/images/net_core_teamcity.png
tags:
  - DevOps
excerpt: >-
  Automatically deploy and run a console application using TeamCity and Octopus
  Deploy.
---
...
<ImageCard src="/content/images/net_core_teamcity_build_steps.png" alt="Build Steps to build .Net Core" />
...
<ImageCard src="/content/images/net_core_octopus_deploy_process.png" alt="Octopus Deploy Process Steps" />
