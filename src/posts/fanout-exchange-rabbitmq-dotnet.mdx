...
<Figure src="/images/image-4.png" caption="Fanout Exchange in AWS MQ RabbitMQ console showing the two queues and the bindings." />
...
<Figure src="/images/RabbitMQ-Fanout-Exchange.gif" caption="RabbitMQ Fanout exchange sending messages to all bounded queues." />
