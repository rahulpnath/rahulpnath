...
date: '2021-08-12'
feature_image: /content/images/docker_ship.jpg
tags:
  - AWS
  - Lambda
excerpt: >-
  Learn how to set up and run Docker Container Images from AWS Lambda. We will
  PGP sign and encrypt a file from AWS S3 in a lambda running a Docker image
  hosted in AWS ECR.
---
...
<EmbedCard src="https://www.youtube.com/embed/WuKbZATHzVE" />
...
<ImageCard src="/content/images/gpg_help.jpg" alt="PGP command line help information" />
...
```
<ImageCard src="/content/images/gpg_decrypt.jpg" alt="gpg decrypt output with signature verification" />
...
<ImageCard src="/content/images/aws_lambda_docker_ecr.jpg" alt="Publish Docker images to AWS ECR" />
...
<ImageCard src="/content/images/aws_lambda_docker_ecr_image.jpg" alt="Latest Docker image published to AWS ECR" />
...
<ImageCard src="/content/images/aws_lambda_container_image.jpg" alt="Create new AWS Lambda function using Container Image" />
...
<ImageCard src="/content/images/aws_lambda_docker_s3.jpg" alt="AWS S3 containers to upload files" />
...
<ImageCard src="/content/images/aws_lambda_permissions.jpg" alt="AWS Lambda Permissions configuration" />
...
<ImageCard src="/content/images/aws_lambda_s3_iam_permissions.jpg" alt="Add permissions to Lambda to access specific S3 buckets to read/write" />
...
<ImageCard src="/content/images/aws_lambda_s3_trigger.jpg" alt="Set up lambda trigger when a new file is added to S3 bucket" />
...
<ImageCard src="/content/images/aws_labda_timeout.jpg" alt="AWS Lambda default timeout of 3 sec. Make sure to update to the required value." />
...
<ImageCard src="/content/images/aws_lambda_docker_publish_visual_studio.jpg" alt="Publish AWS Lambda Docker container image from Visual Studio AWS Toolkit" />
...
<ImageCard src="/content/images/aws_lambda_docker_publish_visual_studio_advanced_settings.jpg" alt="Publish AWS Lambda Docker container image advanced settings from Visual Studio AWS Toolkit" />
