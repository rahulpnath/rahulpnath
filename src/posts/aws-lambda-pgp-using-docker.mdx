...
<Figure src="/images/gpg_help.jpg" caption="Type in gpg -h to get details and help on how to use the tool." />
...
<Figure src="/images/gpg_decrypt.jpg" caption="## PGP From .NET Core" />
...
<Figure src="/images/aws_lambda_docker_ecr.jpg" caption="To upload images to this repository, click the '_View push commands_' button to see the commands." />
...
<Figure src="/images/aws_lambda_docker_ecr_image.jpg" caption="## Publish To Lambda" />
...
<Figure src="/images/aws_lambda_docker_s3.jpg" caption="### Setup IAM Permissions and Lambda Trigger" />
...
<Figure src="/images/aws_lambda_s3_trigger.jpg" caption="### Lambda Timeout" />
...
<Figure src="/images/aws_labda_timeout.jpg" caption="## Packaging & Publishing - Visual Studio" />
