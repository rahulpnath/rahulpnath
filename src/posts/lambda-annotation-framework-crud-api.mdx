...
date: '2023-08-30'
feature_image: /content/images/2023/08/Lambda-Annotation-Framework---CRUD.png
tags:
  - AWS
  - Lambda
excerpt: >-
...
In a [previous post](/blog/aws-lambda-annotation-framework/), we learned how to get started with using the Annotations Framework and how it compares to using the default Lambda Programming model. The Annotations Framework removes boilerplate code required to integrate with API Gateway.

<EmbedCard src="https://www.youtube.com/embed/Zx6JpVKUoLQ?feature=oembed" title="SERVERLESS CRUD API | Lambda Annotations Framework |  .NET ON AWS | Serverless | Amazon" />
...
<ImageCard src="/content/images/2023/08/image-1.png" alt="Lambda Annotations Framework generated code using Source Generator." caption="Lambda Annotations Framework generated code using Source Generator." />
