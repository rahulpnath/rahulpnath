...
excerpt: >-
  In an earlier post, we saw how to enable Role-Based Access for .Net Core Web
  applications(GHOSTURL/blog/dot-net-core-api-and-azure-ad-groups-based-access/).
  We used hardcoded AD Group Id's in the application as below  json
  "AdGroups":...
tags:
  - Azure
---
...
<iframe src="https://www.youtube.com/embed/__StouilkH0" />
