...
date: '2019-10-06'
feature_image: /content/images/azure_ad_app_graph_api.jpg
tags:
  - Azure
---
In an earlier post, we saw how to [enable Role-Based Access for .Net Core Web applications](/blog/dot-net-core-api-and-azure-ad-groups-based-access/). We used hardcoded AD Group Id's in the application as below
...
<EmbedCard src="https://www.youtube.com/embed/__StouilkH0" />
...
<ImageCard src="/content/images/azure_ad_app_graph_api.jpg" alt="" />
```csharp
...
<ImageCard src="/content/images/msi_azure_graph_api.jpg" alt="" />
