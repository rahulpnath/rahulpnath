...
excerpt: >-
  If you have decided on Checking in Package Dependencies into Source
  Control(GHOSTURL/blog/checking-in-package-dependencies-into-source-control/)
  for an existing project that uses Nuget Packages then this post is for you 
  When using NuGet...
tags:
  - Programming
---
