...
_If you have decided on [Checking in Package Dependencies into Source Control](/posts/checking-in-package-dependencies-into-source-control/) for an existing project that uses Nuget Packages then this post is for you_
