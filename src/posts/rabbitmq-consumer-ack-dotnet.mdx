...
date: '2024-02-12'
feature_image: /content/images/2024/02/_RabbitMQ---ACK.png
tags:
  - RabbitMQ
  - AWS
excerpt: >-
...
<ImageCard src="/content/images/2024/02/image.png" alt="RabbitMQ configuration in Amazon MQ to override the consumer_timeout value to be 30 seconds instead of the default 30 minutes." caption="RabbitMQ configuration in Amazon MQ to override the consumer_timeout value to be 30 seconds instead of the default 30 minutes." />
