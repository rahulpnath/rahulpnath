...
date: 2010-07-01
feature_image: /images/database_sync.jpg
excerpt: >-
  !Database Synchronization(/images/databasesync.jpg)  Updating an old database, with newly created/modified database objects(mostly stored procedures,views,functions and table value parameters), from a new database was a very common,tedious,error prone task that was...
tags:
  - Dotnet
  - Tools
---
![Database Synchronization](/images/database_sync.jpg)
