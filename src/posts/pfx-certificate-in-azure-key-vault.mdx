...
date: "2016-03-18T12:21:03.000Z"
feature_image: "/images/pfx_security.jpg"
tags: ["Azure"]
---

**Note:** Azure Key Vault now support Certificates as a first class citizen. Check out the post, [Manage Certificates in Azure Key Vault](/posts/manage-certificates-in-azure-key-vault/) for more details.
