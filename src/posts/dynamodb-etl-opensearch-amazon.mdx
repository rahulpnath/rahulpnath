...
date: 2024-11-29
feature_image: /images/DynamoDB-Zero-ETL.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/iRTllEbrrUk?feature=oembed" />
...
<Figure src="/images/image-16.png" caption="Point-in-time recovery turned on for DynamoDB table under Backups in AWS Console." />
...
<Figure src="/images/image-9.png" caption="DynamoDB Streams turned on For Zero ETL OpenSearch Plugin" />
...
<Figure src="/images/image-10.png" caption="Creating a new DynamoDB Zero ETL Data ingestion pipeline for Amazon OpenSearch from AWS Console." />
...
<Figure src="/images/image-13.png" caption="DynamoDB Zero ETL to OpenSearch IAM Role" />
...
<Figure src="/images/image-15.png" caption="Amazon OpenSearch Dashboard Dev Tools to run queries" />
