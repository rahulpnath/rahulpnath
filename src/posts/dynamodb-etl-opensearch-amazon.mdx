...
Point-in-time recovery turned on for DynamoDB table under Backups in AWS Console.
...
DynamoDB Streams turned on For Zero ETL OpenSearch Plugin
...
Creating a new DynamoDB Zero ETL Data ingestion pipeline for Amazon OpenSearch from AWS Console.
...
DynamoDB Zero ETL to OpenSearch IAM Role
...
Amazon OpenSearch Dashboard Dev Tools to run queries
