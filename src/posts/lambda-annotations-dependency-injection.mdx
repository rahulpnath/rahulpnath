---
title: >-
  How To Set Up Dependency Injection in Lambda Functions Using Annotations
  Framework
slug: lambda-annotations-dependency-injection
date: '2023-09-04'
feature_image: /content/images/2023/09/Lambda-Annotation-Framework---DI.png
tags:
  - AWS
  - Lambda
excerpt: >-
  Learn how to set up Dependency Injection when building Lambda Functions using
  the Annotatios framework.
---
The Lambda Annotations Framework provides a programming model for .NET developers to create AWS Lambda Functions.

In previous posts, we learned [how to get started with the Annotations Framework](/blog/aws-lambda-annotation-framework/) and also [how to build a CRUD API](/blog/lambda-annotation-framework-crud-api/) using the Annotations Framework.
...
<EmbedCard src="https://www.youtube.com/embed/FPaznlIY02s?feature=oembed" title="DEPENDENCY INJECTION Lambda | Lambda Annotations Framework |  .NET ON AWS | Serverless | Amazon" />
...
<EmbedCard src="https://www.youtube.com/embed/YR6HkvNBpX4?feature=oembed" title="DEPENDENCY INJECTION in ASP.NET Core | Getting Started With ASP.NET Core Series" />
...
<BookmarkCard href="/blog/lambda-lifecycle-and-net/" title="Why You Should Care About Lambda Lifecycle As A .NET Developer?" description="The Lambda Lifecycle affects the way we write out Function code. Learn some of the dos and don’ts when building Lambda Functions in .NET because of how Lambda initializes the Function classes." icon="/content/images/size/w256h256/2022/10/logo-512x512.png" />
...
<ImageCard src="/content/images/2023/08/image-2.png" alt="The Lambda generated class by the annotation framework as seen using JetBrains dotpeek." caption="The Lambda generated class by the annotation framework as seen using JetBrains dotpeek." />
