...
Thanks to AWS for sponsoring this article in my [AWS Lambda Series.](/posts/tag/lambda/)
...
![](/images/logo-512x512-18.png)Rahul NathRahul Pulikkot Nath

![](/images/Lambda-SnapStart.png)

](/posts/aws-lambda-snapstart/)
...
Below are the CloudWatch LogInsights logs showing the Restore Duration and Init Duration for the function we built in the [Getting Started with AWS Lambda SnapStart](/posts/aws-lambda-snapstart/).
...
It now has a 5-second delay, which could be the case for some of your production workloads, especially if you are [hosting a full ASP.NET API](/posts/asp-net-core-on-aws-lambda/) or similar workloads.
