...
![Create a new secret from AWS Secrets Manager in console](/images/aws-secrets-manager-new-secret.jpg)![New Secret meta information and name](/images/aws-secret-manage-new-secret-meta.jpg)
