...
<iframe src="https://www.youtube.com/embed/-46yTm4DoEI" />
...
![Text based filtering in CloudWatch log group, Showing all logs which do not have Brisbane and have number 9](/images/aws-cloudwatch-logs-text-filter.jpg)
...
![Text based Logs vs structured logging](/images/aws-cloudwatch-log-comparison.jpg)
...
![JSON based log filtering example with multiple properties](/images/aws-cloudwatch-log-structured-filter.jpg)
...
![Sample query in aws cloudwatch log insights](/images/aws-cloudwatch-logs-insights.jpg)
...
![Query across multiple log groups in CloudWatch log insigths](/images/aws-cloudwatch-logs-insights-multiple-log-groups.jpg)
...
![Saved queries in CloudWatch Log Insights](/images/aws-cloudwatch-logs-insights-saved-queries.jpg)
