...
<PostCard 
  ...
  description="Delivery processing acknowledgements from consumers are referred to as acknowledgements in messaging protocols. Let’s learn automatic and manual ack modes in RabbitMQ."
  slug="rabbitmq-consumer-ack-dotnet/"
  image="/images/_RabbitMQ---ACK.png"
/>
