...
Code formatting is an important aspect of coding. It is important that as a team you need to agree on some standard practices and find ways to stick to it. You can use <BlogLink
  ...
  featureImage="/images/codeformatting_column_guide.png"
/>, <BlogLink
  href="/blog/code-review"
  ...
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/codereview_friendly.png"
/>, etc. to make sure it does not get missed. It takes a while for any new practices to set in, but soon it will be of second nature and easy to follow.
