...
-   <BlogLink
  href="/blog/generating-a-large-pdf-from-website-contents"
  ...
  featureImage="/images/pdf_generation_flow.png"
/>
-   <BlogLink
  href="/blog/generating-a-large-pdf-from-website-contents-part-ii"
...
/>
-   <BlogLink
  href="/blog/generating-a-large-pdf-from-website-contents-part-iii"
  title="Generating a Large PDF from Website Contents - Merging PDF Files"
  description="Dynamically generate a PDF file for a CMS Website."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
...
In the previous post, <BlogLink
  ...
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/pdf_generation_flow.png"
/>, we saw how to generate a PDF from HTML and add bookmarks to the generated PDF files. The PDF file generated is for an individual section which now needs to be merged to form a single PDF file. The individual PDF files contain the relevant content for the section and related bookmarks, which needs to be combined into a single PDF file.
