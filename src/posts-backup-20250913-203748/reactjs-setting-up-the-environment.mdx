...
date: '2016-05-12'
feature_image: /images/react_vscode_intellisense.png
tags:
  - Programming
---
...
![Visual Studio code jsconfig balloon notification](/images/vscode_jsconfig_balloon.png)
...
```
![Visual Studio code Intellisense](/images/react_vscode_intellisense.png)
...
![React real-time browser refresh](/images/react_realtime_edits.gif)
...
You can find the hello world project template [here](https://github.com/rahulpnath/Blog/tree/master/React_Template). The repository size is a bit high as I have <BlogLink
  href="/blog/checking-in-package-dependencies-into-source-control"
  ...
  featureImage="/images/nuget_package_sources.png"
/> (_node\_modules_) in the repository, which you would have anyways downloaded when doing a '[npm install](https://docs.npmjs.com/cli/install)'.
