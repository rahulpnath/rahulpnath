...
It's not long back that we saw a new technology stack come up in ASP.Net, which redefined the way we were building services - <BlogLink
  href="/blog/wcf-to-asp-net-web-api"
