...
Keeping all your scripts in a single place and automating it through the build-release pipeline is [Working Effectively Under Constraints](/blog/working-effectively-under-constraints/). Hope this helps you to continue using DbUp even if you want to execute scripts that are a mix of transactional and non-transactional.
