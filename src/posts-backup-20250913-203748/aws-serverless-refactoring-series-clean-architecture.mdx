...
date: '2021-05-03'
feature_image: /images/aws_serverless_refactor_project.jpg
excerpt: >-
...
tags:
  - AWS
---
_This is Part 1 of the <BlogLink
  href="/blog/aws-serverless-refactoring-series"
  title="AWS Serverless Refactoring Series: How to Improve the Maintainability of Project"
  description="Let's look at different design patterns and principles we can apply to make the default AWS Serverless Application Template cleaner and easier to maintain."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/aws_serverless_refactor.jpg"
/>, where I refactor the default AWS Serverless Application template to a more maintainable and easy to extend architecture._
