...
date: '2023-10-09'
feature_image: /images/Add-To-Apple-Wallet.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/mcR08yyFpaU?feature=oembed" />
...
All we need to do is add the [Lambda Annotations Framework](/blog/aws-lambda-annotation-framework/) NuGet package and wrap our Pass Generation function with the `LambdaFunction` attribute. Since this is going to be exposed as an API will also add the `HttpApi` attribute and specify the route and the method `Get`.
...
The `HttpApi` attribute allows us to expose the Lambda Function over a [Function URLs - Quick and Easy way to Invoke AWS Lambda Functions over HTTP](/blog/function-urls-in-aws-lambda-dotnet/) or an [HTTP APIs](/blog/amazon-api-gateway-http-apis/).
...
Apple Wallet Passes added to phone showing the front and the back details of the pass.
