...
date: '2017-09-09'
feature_image: /images/pdf_sign.png
excerpt: Sign PDF files without needing to print and scan them back again.
tags:
  - Tools
---
Very often I need to sign forms, receipts, invoices in PDF format and send them across to someone else. Printing the PDF, signing them physically and scanning them back (of course using <BlogLink
  href="/blog/office-lens-scan-documents-with-your-phone"
  ...
  featureImage="/images/office_lens.png"
/>) is how I used to do this until a while back. Since I don't have a printer at home, I always had to wait till I reach office. Also, I did not like wasting paper and ink just to put a signature.
...
**1.** Sign on a white paper and take a picture. Upload the picture onto your computer and crop the image using your favorite [Tip of the Week: Paint.net - A Layman's Photoshop](/blog/paint-dot-net/). You should have something similar as shown below.

![Your Signature](/images/pdf_signature.png)
...
![Add your Signature](/images/adobe_add_sign.png)
