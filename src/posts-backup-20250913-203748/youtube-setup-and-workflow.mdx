...
date: '2020-05-01'
feature_image: /images/youtube-setup-2022-may.jpg
tags:
  - Productivity
---
First things first, Kindly [subscribe to my channel](https://www.youtube.com/user/rahulnathp).

It's been three-plus years since I published the [first YouTube video](https://www.youtube.com/watch?v=51Qmk3TQJ44), and here are my [Recording My First Screencast](/blog/recording-my-first-screencast/). Things have changed a lot since then, so I thought of putting this post together on my current setup.
...
Before recording I switch my [Setting Up Dual 4K Monitors - Dell P2715Q and Dell U2718Q](/blog/setting-up-multiple-monitors/) to **1980px x 1080px**(Full HD) resolution. It is important to **record, edit, and publish in the same size settings**. All three software record the audio. When editing, it makes it easy to align the videos together.
