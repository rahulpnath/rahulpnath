...
[![Request/Response flow involved in updating a Apple Wallet Pass using a Web Service Url (source - apple developer documentation page)](/images/client_server_interaction_2x.png)](https://developer.apple.com/library/archive/documentation/UserExperience/Conceptual/PassKit_PG/Updating.html#/apple_ref/doc/uid/TP40012195-CH5-SW1)
