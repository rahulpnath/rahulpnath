...
date: '2016-05-25'
feature_image: /images/service_management_adAccess.png
tags:
  - Azure
---
...
/>, but there are multiple ways of achieving this now - REST API, <BlogLink
...
![AD Application access to Azure Service Management API](/images/service_management_adAccess.png)
