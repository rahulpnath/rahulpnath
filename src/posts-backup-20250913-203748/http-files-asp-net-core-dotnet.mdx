...
I will use an API built over <BlogLink
  href="/blog/amazon-dynamodb-dotnet-developer"
  ...
  featureImage="/images/Amazon-DynamoDB.png"
/>, and [ASP.NET Core on Lambda](/blog/asp-net-core-on-aws-lambda/).
