...
-   Dependent DLLs, MSI Installer (that packages the above). We were using the [Azure Devops](https://azure.microsoft.com/en-au/services/devops/) for our build process and wanted to automate the code signing. We are using WIX to generate the MSI installer; Check out my previous post on <BlogLink
  href="/blog/building-windows-service-installer-on-azure-devops"
  ...
  featureImage="/images/azure_devops_wix.jpg"
/>, if you want more details on setting up WIX installer in DevOps.
