...
date: '2023-06-21'
feature_image: /images/DynamoDB-GSI.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/KkbalFKf20A?feature=oembed" />
...
![Create Table UI in Amazon AWS Console. Select Customize settings options to create GSI along with creating your DynamoDB Table.](/images/image-3.png)
...
![Create Secondary Index option in AWS Console. You can create Global and Local Index when creating the table.](/images/image-4.png)
...
![Create GSI dialog which prompty for Partition key, Sort key, Index name and also the Attribure projections.](/images/image-5.png)
...
![Creating a GSI on existing table from the 'Indexes' tab under the table details in AWS Console.](/images/image-8.png)

Choose the `Create index` button for the same dialog to create the GSI on an existing table.

![Create GSI popup with the same required details as when creating on a new table.](/images/image-6.png)
...
<BlogLink
  href="/blog/dynamodb-projection-expressions/"
  ...
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/DynamoDB-Projection-Expressions.png"
/>
...
<BlogLink
  ...
  description="DynamoDB charges for reading, writing, and storing data in your DynamoDB tables. As a rule of thumb, when querying data, you can consider that each record that you retrieve from the database has a direct cost attached to it. Limiting the items you retrieve has a direct impact on saving"
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
