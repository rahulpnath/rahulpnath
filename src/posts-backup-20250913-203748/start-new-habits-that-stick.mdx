...
The ability to pick on something and to make a habit of it is something that is always helpful. This skill helps to create new habits and also let go off old ones that are not doing any good to you. Part of letting of bad old habits might be creating new ones. When I wrote about <BlogLink
  href="/blog/three-months-to-a-half-marathon"
  ...
  featureImage="/images/running_half_marathon.jpg"
/>, some of my readers asked how to keep up with the plan. How to do 'Couch to Street'; just getting out there.
...
Break your goals into small and achievable mini goals. These mini goals are often referred to as <BlogLink
...
/>, <BlogLink
  href="/blog/experimenting-with-pomodoro-technique"
  title="How I Included Scrum and Pomodoro Technique in My Morning Routine"
  description="Updates to my Morning Routine."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/pomodoro_plan.png"
/> etc. The key is to break them down into smaller achievable mini-goals and setting a cue to trigger the activity.
...
Once you have decided to pursue the idea, break it into smaller pieces and set achievable 'mini goals.' Set dedicated time at regular intervals for achieving these mini-goals. Most important is in having some 'me time' to get towards these goals. Like for me I have found that [Waking up Early is All About Waking up to an Alarm](/blog/waking-up-early-is-all-about-waking-up-to-an-alarm/) and created a [My Morning Routine](/blog/morning-routine/). To make sure that I make the best of my time I try to work in [How I Included Scrum and Pomodoro Technique in My Morning Routine](/blog/experimenting-with-pomodoro-technique/) often.

## Tracking and Feedback

Tracking is an important part of habit formation. Once you have set your goals and mini habits also find ways to track your progress. <BlogLink
  href="/blog/psm-learnings"
  title="Learnings from The Professional Scrum Master (PSM) Course"
  description="My takeaways from the 2-day PSM Course."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/scrum_framework.png"
/> is the fundamental principle behind Agile Processes. Habit formation is nothing but being agile, keeping the end goal in mind, adjusting the way you reach there. Find ways and tools to track progress on the habits that you are trying to form.

I prefer automatic tracking with least manual entry, so the tracking happens in the background. But at times you will have to resort to manual methods as well. Make sure you have a time set aside daily to capture the information. Having a review of the data obtained once every week or two and taking adjustment actions is equally important. Some of the tracking tools that I use are <BlogLink
  href="/blog/rescue-time-track-your-time"
  title="Tip of the Week: Rescue Time - Track Your Time"
  description="Wondering where your time goes? Start Tracking!"
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/rescuetime.png"
/>, <BlogLink
  href="/blog/three-months-to-a-half-marathon"
  title="How I Went From Couch to Half Marathon in Twelve Weeks"
  description="Update on how I have been going about my running."
  ...
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/running_half_marathon.jpg"
/> and a few manual ones. I \[review my progress every week\] and try to incorporate feedback into the upcoming week.

> _All it takes to start a new habit is a moment - The moment where you decide on the new habit. The rest is process!_

<BlogLink
  href="/blog/how-i-lost-13-kilos-in-one-and-half-months"
  title="How I Lost 13 Kilos in One and Half Months"
  description="Read this interesting blog post"
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/weigth_Before-and-After.jpg"
/>, <BlogLink
  href="/blog/maintaining-a-blogging-schedule"
  title="Maintaining a Blogging Schedule"
  description="Tips and tricks for blogging regularly."
...
/>, <BlogLink
  ...
  featureImage="/images/pomodoro_plan.png"
/> and <BlogLink
  href="/blog/recording-my-first-screencast"
  title="Recording My First Screencast"
  description="Read this interesting blog post"
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/screencast_microphone_rode.jpg"
...
[![Power Of Habit](/images/books_powerofhabit.jpg)](http://amzn.to/2gOYluc)[![Superhuman by Habit](/images/books_superhumanbyhabit.jpg)](http://amzn.to/2hmeokB)
