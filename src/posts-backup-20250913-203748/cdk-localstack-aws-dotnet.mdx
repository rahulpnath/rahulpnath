...
Thanks to AWS for sponsoring this post in my <BlogLink
  href="/blog/tag"
  title="Tag"
...
In the Getting Started with LocalStack article, I showed different ways to [How to Use LocalStack for Seamless AWS Development in .NET](/blog/aws-localstack-dotnet/).
