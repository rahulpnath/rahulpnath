...
excerpt: >-
  Looking to stay overnight for a short vacation. Here are a list of places
  around Sydney.
tags:
  - Life
---
A while back I had written about various [One Day Trips Around Sydney](/blog/one-day-trips-around-sydney/). Here is a list of places that we traveled around Sydney during long weekend breaks with a day or two overnight stays.

> [**TLDR;**](https://en.wikipedia.org/wiki/Wikipedia:Too_long;_didn%27t_read)

-   <BlogLink
  href="/blog/three-day-trip-to-coffs-harbour-from-sydney"
  ...
  featureImage="/images/coffs_harbour_dorrigo_skyway_lookout.jpg"
/>
