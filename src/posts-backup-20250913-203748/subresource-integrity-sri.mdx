...
/>. In this post, we explore how to use Subresource Integrity and the issues it solves._
...
![Subresource integrity](/images/sri.png)
...
![Generate script tag along with SRI Hash](/images/sri_redux.png)
