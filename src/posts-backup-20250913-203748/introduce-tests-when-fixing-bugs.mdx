...
excerpt: >-
  Refactoring to add tests when fixing bugs helps increase your confidence and
  grow your test coverage.
tags:
  - Testing
  - Programming
---
...
If you are new to TDD or just getting started with tests, introducing tests while fixing bugs is a good place to start. This might also help make code decoupled and readable. Try [Is Code Coverage a Lie?](/blog/is-code-coverage-a-lie/) the next time you fix a bug!
