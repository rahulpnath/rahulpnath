...
-   **FSharp**FSharp was again on and off this year. Apart from a <BlogLink
  href="/blog/todoist-template-transformer-transform-tasks-to-x-days-from-now"
  ...
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/todoist_templates.png"
/>, I did not do much F# work.
