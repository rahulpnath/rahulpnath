...
I have already put out a detailed post on how to implement an application bar using MVVM. It details out 2 approaches one using Messenger and another having the applciation bar as a service. Check it out at  - <BlogLink
  href="/blog/windows-phone-series-mvvm-and-applicationbar"
  ...
  featureImage="/images/wp_applicationbar_icon_mvvm.png"
/>
