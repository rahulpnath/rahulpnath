...
For transient errors, message processing can succeed in subsequent retries. You can also set up a [Amazon SQS](/blog/amazon-sqs/) to hold messages that fail to be processed for code/business-level errors or exceptions.
