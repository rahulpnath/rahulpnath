...
date: '2025-02-11'
feature_image: /images/Lambda-SnapStart-For-You-.png
excerpt: >-
...
<iframe src="https://www.youtube.com/embed/lce7O0Gd5z4?feature=oembed" />
...
Thanks to AWS for sponsoring this article in my <BlogLink
  href="/blog/tag"
  title="Tag"
...
<BlogLink
  href="/blog/aws-lambda-snapstart/"
  title="Getting Started with AWS Lambda SnapStart: A Beginner’s Guide"
  description="AWS Lambda SnapStart is a performance optimization that speeds up startup times for Lambda Functions, typically with no changes to your function code. Let’s learn how to enable it on your existing functions, how it works under the hood and make sure your Lambda Functions are SnapStart ready."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/Lambda-SnapStart.png"
/>
...
Below are the CloudWatch LogInsights logs showing the Restore Duration and Init Duration for the function we built in the [Getting Started with AWS Lambda SnapStart: A Beginner’s Guide](/blog/aws-lambda-snapstart/).
...
It now has a 5-second delay, which could be the case for some of your production workloads, especially if you are [ASP.NET Core on Lambda](/blog/asp-net-core-on-aws-lambda/) or similar workloads.
