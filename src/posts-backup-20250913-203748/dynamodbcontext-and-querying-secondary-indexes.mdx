...
You can specify the table name via the `OverriderTableName` property or use the `DynamoDBTable` attribute. Check out the [DynamoDB table naming](/blog/dynamodb-net-table/) to learn more.
