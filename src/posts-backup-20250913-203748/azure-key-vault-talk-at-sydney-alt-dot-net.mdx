...
-   Check out various aspects of Key Vault, Authentication, using from ARM templates, etc. [on this blog](/tag/azure-key-vault/).
-   [Azure Resource Manager (ARM) Quickstart templates](https://azure.microsoft.com/en-us/resources/templates/?term=%22key+vault") for Azure Key Vault. Check out more about [Managing Azure Key Vault using Azure Resource Manager (ARM) Templates](/blog/managing-azure-key-vault-using-azure-resource-manager-arm-templates/).
