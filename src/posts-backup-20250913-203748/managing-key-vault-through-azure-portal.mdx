...
date: '2016-11-01'
feature_image: /images/keyvaultportal_create_key_vault.png
excerpt: Walkthrough Key Vault features available in Azure Portal.
tags:
  - Azure
---
You can now manage Key Vault through the Azure portal. Prior to this the Key Vault's were managed either using <BlogLink
...
/>, <BlogLink
  href="/blog/managing-azure-key-vault-using-azure-resource-manager-arm-templates"
  ...
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/default-feature.jpg"
/> or [Managing Azure Key Vault over the REST API](/blog/managing-azure-key-vault-over-the-rest-api/). Managing key Vault is now easy and user-friendly for the nontechnical people. In this post, I will walk through the new features in Azure Portal to manage key vault.
...
![Key Vault in Azure Portal](/images/keyvaultportal_menu_option.png)
...
![Create Key Vault in Azure Portal](/images/keyvaultportal_create_key_vault.png)
...
![Key Vault Add Access Policy](/images/keyvaultportal_access_policy.png)

You can specify the Key Permissions and the Secret Permissions that the ServicePrincipal.

![Access Policy set Secret Permissions](/images/keyvaultportal_secretpermissions.png)
...
![Access Policy set Secret Permissions](/images/keyvaultportal_keyvault.png)
