...
It’s <BlogLink
  href="/blog/avoid-commands-calling-commands"
  ...
  featureImage="/images/sticky_notes.jpg"
/>, so that we can track and manage them independently. For example, if an email fails, we can retry it separately, and it doesn’t have to affect regenerating the report or saving new weather data itself.
