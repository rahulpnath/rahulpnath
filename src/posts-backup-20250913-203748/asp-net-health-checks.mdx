...
AWS sponsors this post, which is part of my [Tag](/blog/tag/).
...
<BlogLink
  href="/blog/aws-rds-sql-server-dotnet/"
  title="AWS RDS and .NET: Step-by-Step Guide for SQL Server Setup"
  description="Amazon Relational Database Service (RDS) is a managed database service on AWS Cloud. RDS provides different database engines; in this post, we will focus on SQL Server. We will set up a Microsoft SQL Server database on RDS and connect to it from a .NET application."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/RDS-SQL-Server--1-.png"
/>
