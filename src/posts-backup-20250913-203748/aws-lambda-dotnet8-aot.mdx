...
<BlogLink
  ...
  featureImage="/images/AWS-Lambda.png"
/>

Thanks to AWS for sponsoring this article in my [Tag](/blog/tag).
...
The [AWS Lambda](/blog/aws-lambda-net-core/) has been updated to create .NET 8 Lambda functions, which makes it easy to create new projects.
...
You can also use the [AWS Lambda](/blog/aws-lambda-net-core/) to run and test your functions locally.
...
You can find the Lambda Init duration in <BlogLink
...
/>, every time a new instance of the function is created. If that entry is missing, it means you are reusing a Lambda instance.
