...
We use the same APIs used in the [BatchWriteItem Operations In DynamoDB Using .NET](/blog/dynamodb-batchwrite/) to perform the batch delete operations as well.
