...
tags:
  ...
  - Tools
---
A lot of trivial tasks that we do daily on our computer can be automated to make it faster and reduce the number of keystrokes ([as they are limited](http://www.keysleft.com)). [AutoHoykey](https://autohotkey.com/)(AHK) is an excellent tool to automate a lot of these and is [Tools that I use](/blog/tools-that-I-use/). I use a very limited set of functionality of AHK, to set up hot strings, launch applications, and mapping caps lock as backspace. The installer to the latest version is available [here](https://autohotkey.com/download/ahk-install.exe).
...
![Visual Studio Code Coverage](/images/ahk_task_general.png)![Visual Studio Code Coverage](/images/ahk_task_trigger.png)![Visual Studio Code Coverage](/images/ahk_task_actions.png)
