...
You can build application APIs on Lambda Function with API Gateways (<BlogLink
...
/>) or [Function URLs - Quick and Easy way to Invoke AWS Lambda Functions over HTTP](/blog/function-urls-in-aws-lambda-dotnet/).
...
Navigate to the Function URL to access the ASP NET API Application. You can also add [securing Function URLs](/blog/how-to-secure-and-authenticate-lambda-function-urls/) to protect the API endpoint for specific applications or users with access.
