...
Building out a niche for myself is something [2019 review](/blog/2019-recap/) I started doing this with my YouTube channel. The goal was to publish three videos every month while also concentrating on a particular topic.
...
-   **Learning and Reading** I had set a goal of reading 12 books but could only get to 5. However, I am happy to have done the [Building a Second Brain Course](https://www.buildingasecondbrain.com/) by Tiago on Personal Knowledge Management. The course has changed the way I consume information online. I am slowly building out my Personal Knowledge Management System. I have started taking <BlogLink
...
I currently manage my Areas of Focus, Goals, and Ideas in [Notion](http://notion.so/) as a table. I still do <BlogLink
  href="/blog/bullet-journaling"
  title="Bullet Journaling: How To Be More Productive With a Pen and Paper System"
  description="Read this interesting blog post"
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/bujo_monthly_habit_tracker3.jpg"
/>, but maintain it in Notion instead of a physical journal.
