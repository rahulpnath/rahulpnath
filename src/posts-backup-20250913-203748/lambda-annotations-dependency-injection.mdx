...
In previous posts, we learned [Lambda Annotations Framework](/blog/aws-lambda-annotation-framework/) and also [previous post](/blog/lambda-annotation-framework-crud-api/) using the Annotations Framework.
