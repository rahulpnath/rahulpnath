...
Since this function takes in input from API Gateway, it uses `APIGatewayProxyRequest` from the _Amazon.Lambda.APIGatewayEvents_ [nuget package.](https://www.nuget.org/packages/Amazon.Lambda.APIGatewayEvents/) You can run the Function code locally using Mock Lambda Test Tool [AWS Lambda](/blog/aws-lambda-net-core/)
