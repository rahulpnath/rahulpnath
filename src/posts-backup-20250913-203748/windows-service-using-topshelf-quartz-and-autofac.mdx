...
tags:
  - Programming
---
Whenever there is a need for some automated jobs that have to run On-Prem for a client, my default choice has been to use Windows Service along with Quartz. Last year I had blogged about [Scheduling Recurring Jobs With a Cool-Off Period](/blog/scheduling-recurring-jobs-with-a-cool-off-period/). However, I did not get into the detail of setting up the project and associated dependencies to run the service.
