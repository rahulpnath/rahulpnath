...
tags:
  - Tools
---
[Fiddler](http://www.telerik.com/fiddler) is an HTTP debugging proxy server application and captures HTTP and HTTPS traffic. It is one of the tools in my [Tools that I use](/blog/tools-that-I-use/). Fiddler allows debugging traffic from PC, MAC, Linux and mobile systems. It helps inspect the raw requests and responses between the client and the server.
...
-   <BlogLink
  href="/blog/using-fiddler-to-help-in-manual-testing"
  ...
  featureImage="/images/fiddler_composer.png"
/>Manually compose requests to send to server and test endpoints.
-   <BlogLink
  href="/blog/simulating-delays-in-http-calls-for-manual-tests"
  ...
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/fiddler_delay.png"
