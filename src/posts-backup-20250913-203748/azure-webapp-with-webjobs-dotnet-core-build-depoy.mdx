...
I keep getting this question. I had covered how to [previous post](/blog/azure-webjobs-dotnet-core-build-depoy/) in a previous post. Check that out if you are getting started with WebJobs.
...
-   **WebJobExample.WebJob -** Web Job Application (set up in this <BlogLink
  href="/blog/azure-webjobs-dotnet-core-build-depoy"
  ...
  featureImage="/images/devops_webjob.jpg"
/>)
...
![Azure DevOps Release Varialbes](/images/web_app_with_web_job_release_variables.jpg)<BlogLink
