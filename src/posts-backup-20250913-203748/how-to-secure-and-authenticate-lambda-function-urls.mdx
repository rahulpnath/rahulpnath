...
tags:
  ...
  - Lambda
---
_This article is sponsored by AWS and is part of my [Category](/blog/category/)._

In a previous blog post, <BlogLink
...
/>, we learned how to expose and invoke Lambda functions over an HTTP endpoint.
