...
Querying using Local Secondary Index, is very similar to using a Global Secondary Index, which we have seen before when [GSI post](/blog/dynamodb-global-secondary-index-gsi/)
