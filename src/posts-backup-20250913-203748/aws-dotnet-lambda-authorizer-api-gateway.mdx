...
We need to set the Authorizer explicitly for each Method endpoint for the API. This is set under the [previous post](/blog/amazon-api-gateway-rest-api-introduction/).
