...
Now that I have to manage the AsmSpy Chocolatey package installations, I decided to automate the process of Chocolatey package creation and upload. Since I had used AppVeyor for [Automated ClickOnce Deployment of a WPF Application using Appveyor](/blog/automated-clickonce-deployment-of-a-wpf-application-using-appveyor/) of [CLAL](https://github.com/rahulpnath/clal), I decided to use AppVeyor for this.
...
![Github webhook url for appveyor](/images/asmspy_github_webhook.png)
