...
tags:
  - Azure
---
In an earlier post, we saw how to [.Net Core Web App and Azure AD Security Groups Role Based Access](/blog/dot-net-core-api-and-azure-ad-groups-based-access/). We used hardcoded AD Group Id's in the application as below
...
As we have seen in the previous instances with MSI (<BlogLink
  href="/blog/how-to-authenticate-azure-function-with-azure-web-app-using-managed-service-identity"
  ...
  featureImage="/images/azure_function_msi.jpg"
/> and <BlogLink
