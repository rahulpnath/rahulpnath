...
If you are on the Windows platform, you can use <BlogLink
  href="/blog/chocolatey-install-softwares-with-ease"
  ...
  featureImage="/images/chocolatey.png"
/>, which is a Package Manager for Windows. It makes installing software a breeze, including [awscli](https://community.chocolatey.org/packages/awscli) → `choco install awscli`
...
In an earlier post, I had walked through in detail how to get started with [DynamoDB](/blog/aws-dynamodb-net-core/)
