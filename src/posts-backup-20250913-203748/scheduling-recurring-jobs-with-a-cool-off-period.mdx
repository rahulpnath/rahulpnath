...
After reaching out to my <BlogLink
  href="/blog/finding-a-job-abroad"
  ...
  featureImage="/images/finding_job_abroad.png"
/>, I decided to use [Quartz.net](https://www.quartz-scheduler.net/). Many had good experiences using it in the past and recommended it highly. One another option that came up was [FluentScheduler](https://github.com/fluentscheduler/FluentScheduler). There was no particular reason to go with Quartz.net.
