...
This post is sponsored by AWS and is part of my .<BlogLink
  href="/blog/tag"
  title="Tag"
...
<BlogLink
  href="/blog/async-enumerable-dotnet/"
  title="Getting Started with Async Enumerables: A .NET Developer’s Guide"
  description="AsyncEnumerables enhances eumeration of collections with asynchronous capabilities. In this post, let’s explore how C# combines ‘yield return’ with ‘async’ and ‘await’ to create efficient asynchronous data streams and how ‘await foreach’ lets us effortlessly consume them."
  authorImage="/images/logo-512x512-24.png"
  authorName="Rahul Nath"
  authorTitle="Rahul Pulikkot Nath"
  featureImage="/images/AsyncEnumerable--2-.png"
/>
