...
tags:
  - Azure
---
**Note:** Azure Key Vault now support Certificates as a first class citizen. Check out the post, <BlogLink
  href="/blog/manage-certificates-in-azure-key-vault"
...
Now that I am able to use the PFX file (which essentially is a software-protected key) to encrypt/decrypt data, I will upload this to the Azure Key Vault so that it stays secure there. If you are new to Azure Key Vault and want to get started check my [other posts](/tag/azure-key-vault/).
