...
I use the command line mostly for interacting with git repositories and like having shorter commands for commonly used commands, like _git status_, _git commit_, etc. My previous command-line, <BlogLink
  href="/blog/cmder-portable-console-emulator-for-windows"
